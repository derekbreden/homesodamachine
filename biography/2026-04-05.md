...
The full analysis of this failure is in [how-ai-built-the-parts.md](/biography/how-ai-built-the-parts.md). The short version: no amount of pipeline scaffolding, rubrics, or validation checks can substitute for spatial understanding. The AI doesn't know what it's building.
