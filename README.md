...
The prototype that proves the dispense path is in Derek's kitchen today — a Lilium under-counter carbonator with peristaltic pumps injecting flavor concentrate into the dispensed water. The origin story (failed SodaStream, the business-license wall, the AI design wall): [`how-this-got-built.md`](how-this-got-built.md).
