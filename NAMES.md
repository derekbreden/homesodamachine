...
| **tee carrier** | `enclosure-tee-carrier-plate`, the printed plate that carries the four barb tees Y-C, Y-D, Y-F and Y-G through both front flanks | moving plate, carrier halves |
