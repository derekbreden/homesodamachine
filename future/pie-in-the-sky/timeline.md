...
- `hardware/README.md` describes the integrated under-counter machine in present tense as "the appliance." Under this framing that document is the engineering spec for HSM 2 specifically.
