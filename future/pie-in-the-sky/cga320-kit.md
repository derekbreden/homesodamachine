...
- **No 5 lb CO2 cylinder.** Customer brings their own, or buys one via the curator brand's other rungs — pick one up locally per [`local-co2.md`](/future/pie-in-the-sky/local-co2.md), or have one delivered per [`co2-service.md`](/future/pie-in-the-sky/co2-service.md)'s non-exchange tier.
...
- A customer who is happy with the kit forever, refilling their tank via [`local-co2.md`](/future/pie-in-the-sky/local-co2.md) or [`co2-service.md`](/future/pie-in-the-sky/co2-service.md). The kit is the entire product for them; we own their CO2 supply for life.
- A customer who likes the kit and upgrades to the appliance rungs. The Lillium + flavor-injector bundle is the natural next step; the appliance is the long-term destination.
