...
**This is a point-in-time snapshot, not a living document.** Captures the workflow that actually worked on the first end-to-end execution — first edited and published video shipped 2026-05-04 (the welding first-weld clip). Originally lived as `marketing/video/video-workflow-2026-05-04.md`; relocated and trimmed in the 2026-05-04 refactor — durable HERO13 settings extracted to [`../equipment.md`](../equipment.md), the actual workflow steps extracted to [`../workflow.md`](../workflow.md) as the living procedure. The narrative below (milestones, what changed vs. plan, open items at the time) is what's frozen here as historical record.
...
(Open-items current state lives in [`../workflow.md`](../workflow.md) Open items section. This list is frozen as of 2026-05-04.)
...
- **Thumbnail process learned in flight** — screenshot a video frame, add big text, set after YouTube processes. Not a friction point, just a step that wasn't explicit in the prior plan. (Subsequently codified as a script: [`../../thumbnail/make.sh`](../../thumbnail/make.sh).)

## What this snapshot is NOT

- Not a video-production manual — it's the workflow that happened to work on the first execution. Live procedure is in [`../workflow.md`](../workflow.md).
