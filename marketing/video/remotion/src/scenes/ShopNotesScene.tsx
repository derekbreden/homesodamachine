...
import { MainBoardDrawing } from "../components/shop/MainBoardDrawing";
...
/** The Shop Notes scene: the main board as a living engineering drawing. Timings are
