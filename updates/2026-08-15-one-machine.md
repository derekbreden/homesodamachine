...
Everything since has been subtraction. The stripped-down Lite edition went on 27 July. The added sheet-metal compressor shroud was designed out; the R-600a donor's own moulded terminal cover remained, with a thermal cutoff held against its outside flank by a printed clamp. Capacitive sensing was cut on 10 August, one day after being placed, because no firmware read it. The valve trays, the pump case and the separate front and back panels are gone — eight solenoids and both pumps now stand on the enclosure's own front-top piece, printed wall to wall, and the whole flavor manifold lifts out as one body with the carbonator still full and pressurised.
