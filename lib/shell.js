...
// Box icon for Prints (matches the cube glyph used in /notifications row
// for kind=step, so the same visual identity follows the user from nav
// to inbox).
const PRINTS_SVG = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>`;

// Bar-chart icon for Diagrams (matches kind=mermaid glyph in
// /notifications).
const DIAGRAMS_SVG = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 3v18h18"></path><path d="M18 17V9"></path><path d="M13 17V5"></path><path d="M8 17v-3"></path></svg>`;
...
// (Prints, Diagrams) — they're icons rather than text so the nav fits a
...
export function renderNav({ surface = "public", active = null, devPrefix = "/dev" }) {
  ...
  const iconLinks = [
    { href: prints, name: "prints", label: "Prints", svg: PRINTS_SVG },
    { href: diagrams, name: "diagrams", label: "Diagrams", svg: DIAGRAMS_SVG },
  ];
