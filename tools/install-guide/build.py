...
caption('Stone counter: use a spare 1-3/8 in sink or counter hole, or drill one with a 1-3/8 in diamond core bit kept wet.',275)
line(M,304,W-M,304)
text('Space around the machine',M,314,16,'Bold',NAVY)
text('8-1/2 in wide, 18-3/8 in deep, 14-1/4 in tall.',M,338,10,'Regular',INK)
...
para('From below, hold the steel plate against the counter, <b>above the washer and nut already on the shank.</b> Slide the wide slot around the shank and the narrow slot around the black tubes and cable.',M,340,CW,11,15,limit=75)
...
p=pic('steps/pour-base.png',91,161,244,247,crop=(150,40,1475,1500))
