...
text('A glass full of ice', 30, 27, 27, 'Bold', '#10319C')
text('Ice fills the glass beneath the same top cubes.', 30, 64, 12)
for i, (opacity, title) in enumerate([(70, '70% opacity'), (82, '82% opacity')]):
    x = 30+i*282
    ...
    picture(source, x, 134, 246, 238, (439, 820, 858, 1495))
    text('QUICK START SIZE', x, 399, 8.5, 'Bold', '#606A78')
    picture(source, x+30, 422, 186, 149, (150, 95, 1475, 1495))
text('Glass detail above; the 19 x 13 inch quick start scale below.',
...
subprocess.run(['pdftoppm', '-scale-to', '1800', '-singlefile', '-png',
                str(PDF), str(OUT/'full-ice-opacity')], check=True)
print(PDF)
