...
for row,caption in enumerate(['Plate above','washer + nut']):
    ...
    text(caption,x+272-caption_width,286+row*12,10,'Semibold')
for color,width in [('#ffffff',2.2),(INK,.7)]:
    line(x+278,295,x+291,295,color,width)
...
para('Open the <b>cylinder valve</b> and <b>small knob.</b> Use the <b>big knob</b> to set the upper needle in <b>green.</b> Listen at the nut, gray connector and red CO2 port <b>before power:</b> a hiss is a leak.',x,644,268,12.4,16,limit=64)
x=starts[2]
