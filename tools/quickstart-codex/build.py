...
para('From below, slide the steel plate <b>above the retained washer and nut.</b> Wide slot around the shank; narrow slot around the black tubes. <b>Hand-tighten the nut.</b>',x,403,416,12.5,16,limit=48)
...
para('<b>Choose:</b> tap the faucet display to select a flavor. A dim screen takes one tap to wake.',x,829,280,12,15,limit=45)
para('<b>Pour:</b> place a glass under the faucet and press the lever. Release it to stop.',x,870,280,12,15,limit=30)
q=pic('edge-study/pour-base.png',1010,787,317,117,crop=(150,95,1475,1495))
