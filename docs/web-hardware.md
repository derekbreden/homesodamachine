...
- **Content roots.** `hardware/` and [`pie-in-the-sky/lite/`](/pie-in-the-sky/lite/) behind the edition toggle, [`posts/`](/posts/) for the blog. [`server.js`](/web/server.js), [`viewer-routes.js`](/web/lib/viewer-routes.js).
