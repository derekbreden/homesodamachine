...
- **Headless render reads the viewer's globals.** `window.__hsm` is set in [`main.js`](/web/public/js/viewer/main.js) and read by [`render-step.js`](/tools/render/render-step.js), [`render-dxf.js`](/tools/render/render-dxf.js), [`render-step-side-by-side.js`](/tools/render/render-step-side-by-side.js), [`render-step-posed.js`](/tools/render/render-step-posed.js), [`render-view.js`](/tools/render/render-view.js).
