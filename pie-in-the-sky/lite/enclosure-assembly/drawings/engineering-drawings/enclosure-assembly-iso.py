"""Isometric engineering drawing of the Lite enclosure assembly: HLR
...
default front-iso camera (web/public/js/viewer/scene.js resetCamera: world
camera at +x, -y, +z, up +Z): lid up, contents reading through the
translucent shell.
"""
...
ASSEMBLY_STEP = (
    _repo / "pie-in-the-sky" / "lite" / "enclosure-assembly"
