...
- Closed top (ceiling stays). A rod hang channel is cut into the faces of the
  ...
  arcs anywhere so it prints clean on the −X face. One 1/8" stainless rod ([158 mm](ROD_LENGTH) cut length) threads both bags' centered
...
- `/pie-in-the-sky/lite/printed-parts/reservoir-pockets/reservoir_pockets.py`
