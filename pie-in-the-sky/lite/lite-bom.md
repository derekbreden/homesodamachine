...
| Flavor | Supply Depot 3/8" red BiB connector | 2 | $10.00 | [B0DMFK9B6P](https://www.amazon.com/dp/B0DMFK9B6P) | Optional commercial-syrup input — one per channel (feeds V-K-A, V-K-B), so two distinct bag-in-box syrups. Same part as the Kitchen build ([../../hardware/bom.md](../../hardware/bom.md) §8). A standard commercial soda-syrup disconnect — food-contact by function; snaps onto a syrup bag's red fitment, output is a 3/8" **male** hose barb. Prime, $19.99/2-pack ($10.00/ea) — one 2-pack covers both channels. |
