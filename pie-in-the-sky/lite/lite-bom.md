...
| Flavor | Eldon James C6-4BN 3/8" × 1/4" nylon reducing coupler, black | 2 | $0.75 | [FWS C6-4BN](https://www.freshwatersystems.com/products/3-8-x-1-4-tube-id-nylon-reduction-coupler-black) | Steps each BiB leg from the connector's 3/8" barb down to the 1/4" clear PVC into V-K-A/V-K-B. Tube-ID barb both ends, 6/6 nylon, 150 psi @ 70°F. **Open question — material:** this leg carries un-diluted syrup concentrate (dilution only happens at the nozzle), and nylon is acid-sensitive, so a PP or PVC reducer would suit the acidity better and match the PVC tubing. C6-4BN is the only 3/8→1/4 barbed reducer found so far in a food-grade material at all; the thing to resolve is the material's acid-compatibility, not a listing credential. $0.75/ea (bag of 10 = $7.31). |
