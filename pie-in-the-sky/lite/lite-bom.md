...
| Flavor | neoFit stem-barb, 1/4" stem × 1/4" barb, black acetal (ATBC44-E) | 12 | $0.90 | [FWS ATBC44-E](https://www.freshwatersystems.com/products/neofit-acetal-black-stem-barb-connector-1-4-stem-x-1-4-barb) | One per manifold takeoff — 6 valve ports (V-A, V-B, V-K-A, V-K-B, V-G, V-J) + 6 Y ports (Y-C, Y-D, Y-F, Y-G, Y-E, Y-H). The 1/4" stem pushes into the PTC port; the clear PVC slips over the 1/4" barb. Black acetal + Buna-N, FDA + NSF 51. $0.90/ea from a bag of 10. |
...
| Flavor | neoFit flow-control bulkhead, 1/4" tube, black acetal (ABCVU44-E) | 1 | $4.39 | [FWS ABCVU44-E](https://www.freshwatersystems.com/products/neofit-acetal-black-flow-control-bulkhead-1-4-tube) | In the enclosure wall on the Lillium clean-water feed; a constant-flow bulkhead holding the manifold at its <10 PSI working pressure. Push-connect 1/4", acetal + food-grade EPDM, lead-free, black. $4.39 single / $4.34 per 10. |
