...
D2C sale does not require this listing. A Class I plumbed appliance — four bonded chassis surfaces (pressure vessel, compressor body, compressor shroud, faucet plate) returning fault current through the C14 cord per `hardware/wiring/ac-wiring-schedule.md` — carries the shock-protection obligation regardless of certification path. The standard codifies what ground-fault protection in a household appliance actually requires.
