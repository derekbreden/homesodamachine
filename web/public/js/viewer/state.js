...
//   currentDetail = { type: "step"|"dxf"|"mmd"|"drawing"|"pcb", file } | null
...
export const state = {
  ...
  documents: [],      // PDFs the site hands over whole: {path, title, subtitle, pages, cover, bytes} (contracts/documents.js)
  currentDetail: null,
  mountedDetail: null,
