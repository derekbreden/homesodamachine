...
| [`icons.js`](icons.js) | — | Shared SVG glyphs (cube, chart, gear, bell, scissors, newspaper, file). One source of truth for both nav and notification rows. |
| [`templates/`](templates/) | — | HTML fragments included by the page-render modules above. Currently just `viewer-body.html`. |
