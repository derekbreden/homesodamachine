...
export const ALIASES = {
  ...
  "port-ring-carb": "printed-parts/enclosure/port-ring/port-ring-union.step",
  "port-ring-co2": "printed-parts/enclosure/port-ring/port-ring-neofit.step",
  "port-ring-flavor-a": "printed-parts/enclosure/port-ring/port-ring-union.step",
  "port-ring-flavor-b": "printed-parts/enclosure/port-ring/port-ring-union.step",
  "port-ring-water": "printed-parts/enclosure/port-ring/port-ring-union.step",
