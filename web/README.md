...
| `parts.js` | `/3d`'s page: the three assemblies as one thumbnail each, and a collapsed shelf of what none of them hands over, seated by [`contracts/parts-tree.js`](/web/contracts/parts-tree.js). A part inside an assembly is reached by selecting its solid there. |
