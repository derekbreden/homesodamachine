...
export default () => (
  <board layers={4} outline={[{ x: -66.9, y: -51 }, { x: 60.9, y: -51 }, { x: 60.9, y: 47.7 }, { x: -66.9, y: 47.7 }]} minTraceWidth="0.2mm" minViaHoleDiameter="0.3mm" minViaPadDiameter="0.5mm" pcbStyle={{ silkscreenFontSize: "0.8mm" }} autorouter={{ traceClearance: 0.45 }}>
    ...
    {/* FAUCET + RS485 UART fan off the ESP far row, maze-routed: IO33/IO35 climb to the
        ...
        the pin order forces two crossings, resolved by the layer split, no vias. Each
        <pcbtrace> carves its connection (declared above) from the autorouter; the
        <trace>s stay the netlist. Generated by _maze.ts (faucet485). */}
    <pcbtrace route={[
    ...
    <pcbtrace route={[
      ...
      {route_type:"wire",x:-39.4,y:27.6,width:0.2,layer:"bottom"},
      {route_type:"wire",x:-23.53,y:11.7,width:0.2,layer:"bottom"},
    ]} />
    <pcbtrace route={[
      {route_type:"wire",x:-47.725,y:25.105,width:0.2,layer:"bottom"},
      {route_type:"wire",x:-34.9,y:12.3,width:0.2,layer:"bottom"},
      {route_type:"wire",x:-34.9,y:10.5,width:0.2,layer:"bottom"},
      {route_type:"wire",x:-19.6,y:10.5,width:0.2,layer:"bottom"},
