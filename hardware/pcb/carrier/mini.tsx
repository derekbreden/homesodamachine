...
export default () => (
  <board width="142mm" height="90mm" minTraceWidth="0.2mm" traceClearance="0.4mm">
    <Esp32 x={-40} y={26} />
    <Ds3231 name="U6" x={-15} y={0} />
    <Rs485 name="U7" x={-38} y={-28} />
    <Mcp23017 name="U2" x={22} y={18} addr="0x20" />
    <Mcp23017 name="U3" x={22} y={-23} addr="0x21" />
    <Uln2803 name="U4" x={48} y={22} />
    <Uln2803 name="U5" x={48} y={-19} />
    <Jst name="J1" x={66} y={22} count={9} labels={ulnOUT} rot={90} label="MANIFOLD A" />
    <Jst name="J2" x={66} y={-19} count={9} labels={ulnOUT} rot={90} label="MANIFOLD B" />

    {/* ---- I2C + power: ESP -> DS3231 (in one header, out the other) -> MCPs ---- */}
    {/* ESP into the DS3231 6-pin header */}
    <trace from=".U1B > .IO21" to=".U6H > .SDA" />
    <trace from=".U1B > .IO22" to=".U6H > .SCL" />
    <trace from=".U1A > .3V3" to=".U6H > .VCC" />
    <trace from=".U1A > .GND" to=".U6H > .GND" />
    {/* DS3231 4-pin tap -> MCP 0x20 (the module bridges the two headers) */}
    <trace from=".U6I > .SDA" to=".U2I > .SDA" />
    <trace from=".U6I > .SCL" to=".U2I > .SCL" />
    <trace from=".U6I > .VCC" to=".U2I > .VCC" />
    <trace from=".U6I > .GND" to=".U2I > .GND" />
