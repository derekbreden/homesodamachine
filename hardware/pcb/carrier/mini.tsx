...
export default () => (
  <board layers={4} outline={[{ x: -69, y: -51 }, { x: 61, y: -51 }, { x: 61, y: 49.5 }, { x: -69, y: 49.5 }]} minTraceWidth="0.2mm" minViaHoleDiameter="0.3mm" minViaPadDiameter="0.5mm" autorouter={{ traceClearance: 0.45 }}>
