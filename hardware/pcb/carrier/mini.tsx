...
export default () => (
  <board layers={4} outline={[{ x: -66.9, y: -51 }, { x: 60.9, y: -51 }, { x: 60.9, y: 47.7 }, { x: -66.9, y: 47.7 }]} minTraceWidth="0.2mm" minViaHoleDiameter="0.3mm" minViaPadDiameter="0.5mm" autorouter={{ traceClearance: 0.45 }}>
    ...
    {/* REEDS A fan, maze-routed: octilinear (H/V/45°) paths threaded past U2's
        top-edge I2C header (U2I) and mounting hole and the SDA bus, all on top, no
        vias. Each <pcbtrace>'s endpoints land on the connection's two pads, which the
        core patch reads to carve that connection out of the autorouter; the <trace>
        above stays the netlist. Generated by _maze.ts (8-direction A* with a turn
        penalty) over the live obstacle field. */}
    ...
    <pcbtrace route={[
      ...
      {route_type:"wire",x:7,y:37.3,width:0.2,layer:"top"},
      {route_type:"wire",x:7,y:31.5,width:0.2,layer:"top"},
    ...
    <pcbtrace route={[
      ...
      {route_type:"wire",x:9.4,y:37.2,width:0.2,layer:"top"},
      {route_type:"wire",x:9.4,y:31.4,width:0.2,layer:"top"},
      {route_type:"wire",x:4.5,y:26.5,width:0.2,layer:"top"},
    ]} />
    {/* J6.RA4 -> U2B.GPB3 — 0 vias */}
    <pcbtrace route={[
      {route_type:"wire",x:17.58,y:42.8,width:0.2,layer:"top"},
      {route_type:"wire",x:11.9,y:37.1,width:0.2,layer:"top"},
      {route_type:"wire",x:11.9,y:35.4,width:0.2,layer:"top"},
      {route_type:"wire",x:9.9,y:33.4,width:0.2,layer:"top"},
      {route_type:"wire",x:9.9,y:29.4,width:0.2,layer:"top"},
      {route_type:"wire",x:4.5,y:23.96,width:0.2,layer:"top"},
    ]} />
