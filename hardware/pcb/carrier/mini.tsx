...
export default () => (
  <board layers={4} outline={[{ x: -66.9, y: -51 }, { x: 60.9, y: -51 }, { x: 60.9, y: 47.7 }, { x: -66.9, y: 47.7 }]} minTraceWidth="0.2mm" minViaHoleDiameter="0.3mm" minViaPadDiameter="0.5mm" pcbStyle={{ silkscreenFontSize: "0.8mm" }} autorouter={{ traceClearance: 0.45 }}>
    ...
    {/* FAUCET + RS485 UART fan off the ESP far row, maze-routed: IO33/IO35 climb to
        the FAUCET connector (0 vias each); IO32/IO34 cross under them on the bottom
        layer to reach the RS485 TTL header (1 via each — the pin order forces the two
        crossings). Each <pcbtrace> carves its connection (declared above) from the
    ...
    <pcbtrace route={[
      {route_type:"wire",x:-47.725,y:27.645,width:0.2,layer:"top"},
      {route_type:"wire",x:-39.4,y:27.6,width:0.2,layer:"top"},
      {route_type:"wire",x:-26.7,y:14.9,width:0.2,layer:"top"},
      {route_type:"via",x:-26.7,y:14.9,from_layer:"top",to_layer:"bottom"},
      {route_type:"wire",x:-26.7,y:14.9,width:0.2,layer:"bottom"},
      {route_type:"wire",x:-23.53,y:11.7,width:0.2,layer:"bottom"},
    ]} />
    <pcbtrace route={[
      {route_type:"wire",x:-47.725,y:25.105,width:0.2,layer:"top"},
      {route_type:"wire",x:-37.8,y:25.1,width:0.2,layer:"top"},
      {route_type:"via",x:-37.8,y:25.1,from_layer:"top",to_layer:"bottom"},
      {route_type:"wire",x:-37.8,y:25.1,width:0.2,layer:"bottom"},
      {route_type:"wire",x:-31.8,y:25.1,width:0.2,layer:"bottom"},
    ...
    <pcbtrace route={[
      ...
      {route_type:"wire",x:14,y:41.8,width:0.2,layer:"top"},
      {route_type:"via",x:14,y:41.8,from_layer:"top",to_layer:"bottom"},
      {route_type:"wire",x:14,y:41.8,width:0.2,layer:"bottom"},
    ...
    <pcbtrace route={[
      ...
      {route_type:"wire",x:16.6,y:41.8,width:0.2,layer:"top"},
      {route_type:"via",x:16.6,y:41.8,from_layer:"top",to_layer:"bottom"},
      {route_type:"wire",x:16.6,y:41.8,width:0.2,layer:"bottom"},
