...
const DIM: Record<string, Dim> = {
  ...
  U6: { w: 38.5, h: 21.3 }, // DS3231 rot180
  ...
  R1: { w: 1.6, h: 4.0 }, R2: { w: 1.6, h: 4.0 }, R3: { w: 1.6, h: 4.0 }, R4: { w: 1.6, h: 4.0 },
  J1: jst(9, 90), J2: jst(6, 90), J3: jst(4, 0), J4: jst(6, 90), J5: jst(9, 0),
  J6: jst(5, 0), J7: jst(7, 0), J8: jst(2, 0), J9: jst(3, 0), J10: jst(2, 90), J11: jst(4, 90),
}

// name -> [x, y]  (rotation already baked into DIM)
const PLACE: Record<string, [number, number]> = {
  U6: [-37.15, -27.65], U1: [-31.15, -1], U7: [-29.0, 26.375],
  U2: [14.5, 20.25], U3: [14.5, -20.25], U4: [39.65, 23.02], U5: [39.65, -17.48],
  U8: [-6, -33],
  J1: [56, 23.02], J2: [56, -17.48], J3: [-30, 42.65], J4: [-62, 3], J5: [-27, -46],
  J8: [-52, -43.3], J6: [12.5, 44.4], J7: [13, -46], J9: [-46, 42.65], J10: [56, 5], J11: [-62, -25],
  R1: [-60, -14.6], R2: [-60, -9.6], R3: [-64, -14.6], R4: [-64, -9.6],
}
