...
const PLACE: Record<string, [number, number]> = {
  ...
  U8: [-55, -33],
  J1: [56, 21.42], J2: [56, -15.27], J3: [-43.7, 42.65], J4: [-62, 3], J5: [-27, -46],
  J8: [-62, -11.3], J6: [12.5, 42.8], J7: [13, -46], J9: [-1.7, 42.65], J10: [56, 1.17], J11: [-29.5, 42.65],
  R1: [-19.5, 40.9], R2: [-19.5, 44.4], R3: [-10.5, 40.9], R4: [-10.5, 44.4],
}
