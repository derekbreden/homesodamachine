...
## SMD / full-PCBA successor

A JLCPCB-assembled SMD successor — modules as bare silicon, connectors fab-assembled —
is its own project in [`../pcba/`](/hardware/pcb/pcba/). This board is unaffected.
