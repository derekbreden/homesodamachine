 ...
 */
import {
  i8, at, Esp32, Ds3231, Rs485, Jst, Buzzer, ulnOUT,
} from "./carrier_parts"
...
export default () => (
  <board layers={4} outline={[{ x: -66.9, y: -51 }, { x: 60.9, y: -51 }, { x: 60.9, y: 47.7 }, { x: -66.9, y: 47.7 }]} minTraceWidth="0.2mm" minViaHoleDiameter="0.3mm" minViaPadDiameter="0.5mm" pcbStyle={{ silkscreenFontSize: "0.8mm" }} autorouter={{ traceClearance: 0.45 }}>
    ...
    <Jst name="J7" x={22} y={-38.65} count={7} labels={["GND", "CHI", "CLO", "RB4", "RB3", "RB2", "RB1"]} rot={0} label="REEDS B" />
    ...
    {/* ===== 2nd-pass clean fans — top cluster. Generated by clean-pass.ts
        from live pad coords (rerun after moving U2/U4/J6/J1). Each <pcbtrace>
        carves its connection out of the autorouter and replaces it with a riser
        + one 45deg landing: 0 vias, top layer, crossing-free. ===== */}
