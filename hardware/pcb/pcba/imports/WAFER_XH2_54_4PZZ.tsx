...
export const WAFER_XH2_54_4PZZ = (props: ChipProps<typeof pinLabels>) => {
  ...
  "jlcpcb": [
    "C5359632"
      ...
      footprint={<footprint>
        <platedhole  portHints={["pin4"]} pcbX="3.81mm" pcbY="-0.000127mm" outerDiameter="1.499997mm" holeDiameter="0.9000236mm" shape="circle" />
<platedhole  portHints={["pin3"]} pcbX="1.27mm" pcbY="-0.000127mm" outerDiameter="1.499997mm" holeDiameter="0.9000236mm" shape="circle" />
<platedhole  portHints={["pin2"]} pcbX="-1.27mm" pcbY="-0.000127mm" outerDiameter="1.499997mm" holeDiameter="0.9000236mm" shape="circle" />
<platedhole  portHints={["pin1"]} pcbX="-3.81mm" pcbY="0.000127mm" outerDiameter="1.499997mm" holeDiameter="0.9000236mm" shape="circle" />
...
<silkscreenpath route={[{"x":-6.249974800000018,"y":3.3500568000000612},{"x":6.249873199999911,"y":3.3500568000000612}]} />
<silkscreenpath route={[{"x":6.249873199999911,"y":3.3500568000000612},{"x":6.249873199999911,"y":-2.349703199999908}]} />
<silkscreenpath route={[{"x":-6.249974800000018,"y":-2.349703199999908},{"x":-6.249974800000018,"y":3.3500568000000612}]} />
...
<silkscreenpath route={[{"x":-4.652543400000127,"y":-1.7780761999999868},{"x":-4.652543400000127,"y":-2.349703199999908}]} />
<silkscreenpath route={[{"x":-2.925318000000061,"y":-1.7780761999999868},{"x":-2.925318000000061,"y":-2.349703199999908}]} />
<silkscreenpath route={[{"x":2.9928820000000087,"y":-1.7780761999999868},{"x":2.9928820000000087,"y":-2.349703199999908}]} />
<silkscreenpath route={[{"x":4.618456599999945,"y":-1.7780761999999868},{"x":4.618456599999945,"y":-2.349703199999908}]} />
