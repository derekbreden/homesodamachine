...
<courtyardoutline outline={[{"x":-13.9058,"y":11.6564},{"x":11.41,"y":11.6564},{"x":11.41,"y":-11.4242},{"x":-13.9058,"y":-11.4242},{"x":-13.9058,"y":11.6564}]} />
      ...
      cadModel={{
        ...
        // Keep at 0 — the STEP model is already correctly oriented. Measured (OCP volume centroid +
        // bbox on C5365915.step): the model is west-heavy — 13.5 mm past the footprint centre to the
        // west vs 11.0 mm east, centroid 1.43 mm west — so the snap-fit stub points WEST at offset 0,
        // matching the courtyard/silk stub (courtyard xmin −13.9 vs xmax +11.4). Do NOT set 180: that
        // rotates the stub EAST, away from the footprint (part-orientation audit flags it at 2.49 mm).
        pcbRotationOffset: 0,
