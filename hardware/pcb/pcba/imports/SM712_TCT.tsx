...
export const SM712_TCT = (props: ChipProps<typeof pinLabels>) => {
  ...
  "jlcpcb": [
    "C12067"
      ...
      manufacturerPartNumber="SM712_TCT"
      footprint={<footprint>
...
<courtyardoutline outline={[{"x":-1.8756000000000768,"y":1.774000000000001},{"x":2.0026000000000295,"y":1.774000000000001},{"x":2.0026000000000295,"y":-1.774000000000001},{"x":-1.8756000000000768,"y":-1.774000000000001},{"x":-1.8756000000000768,"y":1.774000000000001}]} />
      ...
      cadModel={{
        objUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C12067.obj?uuid=cefd4596db214da394d9632b2b88f8f2",
        stepUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C12067.step?uuid=cefd4596db214da394d9632b2b88f8f2",
