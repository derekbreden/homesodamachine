...
| [John Guest PP010822E 1/4" OD × 1/4" NPT male connector, black polypropylene (10-pk)](https://www.freshwatersystems.com/products/john-guest-male-connector-nptf-black-polypropylene-1-4-x-1-4-nptf) | JG PP010822E — 1/4" NPT M × 1/4" PTC adapter on the warm-side transition from the GASHER 1/4" NPT check valve above to the 1/4" OD LLDPE that enters the foam shell's shared +Z slot and continues to the top-plate water-inlet port via the TAISHER 316L SS 90° NPT M×F street elbow. UV-stabilized black PP body + EPDM O-ring; **NSF 51 + NSF 61 listed**, FDA-compliant materials; 150 psi @ 70°F. Same JG black-PP family as the §4 CO2-line PP010822E pair, the §8 PP1208E reservoir-cap bulkhead, and the §8 PP2308E manifold Y-divider. 1 adapter per build × 10-pc bag = shared stock with §4 and §8 across 3 fluid paths; FWS order WEBFWS100675224 May 15, 2026, $11.00 line + $5.23 allocated shipping + $1.18 allocated tax = $17.41 delivered ÷ 10 = $1.741/each | 1 (of 10 pk) | $1.74 | $1.74 |
...
| [John Guest PP010822E 1/4" OD × 1/4" NPT male connector, black polypropylene (10-pk)](https://www.freshwatersystems.com/products/john-guest-male-connector-nptf-black-polypropylene-1-4-x-1-4-nptf) | JG PP010822E — 1/4" NPT M × 1/4" PTC adapter pair: one at the WR1110 NPT outlet (converts NPT to PTC for the in-cavity 1/4" tube run), one threading into the TAISHER 316L SS vessel-port elbow (PTC back to NPT) on the CO2-inlet port. UV-stabilized black PP body + EPDM O-ring; **NSF 51 + NSF 61 listed**, FDA-compliant materials; 150 psi @ 70°F. Same NSF cert tier + JG quality as the PP1208E reservoir-cap bulkhead in §8 and the PP2308E manifold Y-divider. 2 adapters per build × 10-pc bag = 2 builds of stock per 10-pack (5/build total across CO2, water inlet, flavor BiB — also listed in §3 and §8); FWS order WEBFWS100675224 May 15, 2026, $11.00 line + $5.23 allocated shipping + $1.18 allocated tax = $17.41 delivered ÷ 10 = $1.741/each | 2 (of 10 pk) | $1.74 | $3.48 |
...
| [John Guest PP010822E 1/4" OD × 1/4" NPT male connector, black polypropylene (10-pk)](https://www.freshwatersystems.com/products/john-guest-male-connector-nptf-black-polypropylene-1-4-x-1-4-nptf) | JG PP010822E — 1/4" NPT M × 1/4" PTC adapter pair: one per BiB-input leg between the MAACFLOW 3/8" barb × 1/4" NPT M adapter (B0DMP77B6S above) and the 1/4" OD LLDPE that feeds the PP2308E Y-divider manifold below. Converts the NPT side of the BiB hose-barb adapter to PTC for the soft-LLDPE manifold leg, mirroring the same NPT↔PTC transition used on the §4 CO2 line and the §3 water inlet. UV-stabilized black PP body + EPDM O-ring; **NSF 51 + NSF 61 listed**, FDA-compliant materials; 150 psi @ 70°F. Same JG black-PP family as the PP2308E Y-divider below and the §8 PP1208E reservoir-cap bulkhead. 2 adapters per build (one per BiB / one per flavor) × 10-pc bag = shared stock with §3 and §4 across 3 fluid paths; FWS order WEBFWS100675224 May 15, 2026, $11.00 line + $5.23 allocated shipping + $1.18 allocated tax = $17.41 delivered ÷ 10 = $1.741/each | 2 (of 10 pk) | $1.74 | $3.48 |
