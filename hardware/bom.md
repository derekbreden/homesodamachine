...
2. **Reservoir cap** clamped to each reservoir body via [6](RES_INSERTS_PER_CAP) ruthex inserts + 6 BNUOK M3×12 SHCS per cap, TPU gasket — geometry + screw spec in [`printed-parts/cold-core/reservoir/generate_step_cadquery.py`](printed-parts/cold-core/reservoir/generate_step_cadquery.py).
