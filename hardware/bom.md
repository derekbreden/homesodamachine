...
| [John Guest PP010822E 1/4" OD × 1/4" NPT male connector, black polypropylene (10-pk)](https://www.freshwatersystems.com/products/john-guest-male-connector-nptf-black-polypropylene-1-4-x-1-4-nptf) | JG PP010822E — 1/4" NPT M × 1/4" PTC adapter pair: one warm-side (between the GASHER 1/4" NPT check valve above and the 1/4" OD LLDPE that enters the foam shell's shared +Z slot), one cold-side (between the LLDPE downstream of the slot and the TAISHER 316L SS 90° NPT M×F street elbow on the top-plate water-inlet Port 2). Mirrors the §4 CO2 path's pattern of one warm-side adapter + one in-cavity adapter at the TAISHER vessel-port elbow — water inlet just puts the second adapter at the top-plate TAISHER instead of the bottom-plate in-cavity TAISHER. UV-stabilized black PP body + EPDM O-ring; **NSF 51 + NSF 61 listed**, FDA-compliant materials; 150 psi @ 70°F. Same JG black-PP family as the §4 CO2-line PP010822E pair, the §8 PP1208E reservoir-cap bulkhead, and the §8 PP2308E manifold Y-divider. 2 adapters per build × 10-pc bag = shared stock with §4 and §8 across 3 fluid paths; FWS order WEBFWS100675224 May 15, 2026, $11.00 line + $5.23 allocated shipping + $1.18 allocated tax = $17.41 delivered ÷ 10 = $1.741/each | 2 (of 10 pk) | $1.74 | $3.48 |
...
| [John Guest PP010822E 1/4" OD × 1/4" NPT male connector, black polypropylene (10-pk)](https://www.freshwatersystems.com/products/john-guest-male-connector-nptf-black-polypropylene-1-4-x-1-4-nptf) | JG PP010822E — 1/4" NPT M × 1/4" PTC adapter pair: one at the WR1110 NPT outlet (converts NPT to PTC for the in-cavity 1/4" tube run), one threading into the TAISHER 316L SS vessel-port elbow (PTC back to NPT) on the CO2-inlet port. UV-stabilized black PP body + EPDM O-ring; **NSF 51 + NSF 61 listed**, FDA-compliant materials; 150 psi @ 70°F. Same NSF cert tier + JG quality as the PP1208E reservoir-cap bulkhead in §8 and the PP2308E manifold Y-divider. 2 adapters per build × 10-pc bag = 2 builds of stock per 10-pack (6/build total across CO2, water inlet, flavor BiB — also listed in §3 and §8); FWS order WEBFWS100675224 May 15, 2026, $11.00 line + $5.23 allocated shipping + $1.18 allocated tax = $17.41 delivered ÷ 10 = $1.741/each | 2 (of 10 pk) | $1.74 | $3.48 |
...
| [John Guest PP010822E 1/4" OD × 1/4" NPT male connector, black polypropylene (10-pk)](https://www.freshwatersystems.com/products/john-guest-male-connector-nptf-black-polypropylene-1-4-x-1-4-nptf) | JG PP010822E — 1/4" NPT M × 1/4" PTC adapter pair: one per BiB-input leg between the MAACFLOW 3/8" barb × 1/4" NPT M adapter (B0DMP77B6S above) and the 1/4" OD LLDPE that feeds the PP2308E Y-divider manifold below. Converts the NPT side of the BiB hose-barb adapter to PTC for the soft-LLDPE manifold leg, mirroring the same NPT↔PTC transition used on the §4 CO2 line and the §3 water inlet. UV-stabilized black PP body + EPDM O-ring; **NSF 51 + NSF 61 listed**, FDA-compliant materials; 150 psi @ 70°F. Same JG black-PP family as the PP2308E Y-divider below and the §8 PP1208E reservoir-cap bulkhead. 2 adapters per build (one per BiB / one per flavor) × 10-pc bag = shared stock with §3 and §4 across 3 fluid paths (6/build total across CO2, water inlet, flavor BiB — also listed in §3 and §4); FWS order WEBFWS100675224 May 15, 2026, $11.00 line + $5.23 allocated shipping + $1.18 allocated tax = $17.41 delivered ÷ 10 = $1.741/each | 2 (of 10 pk) | $1.74 | $3.48 |
...
| [Eoiips polyethylene tubing 1/16" ID × 1/8" OD, 1 m](https://www.amazon.com/dp/B0BWJ3S5NM) | B0BWJ3S5NM — soft food-grade PE liner that slips inside the 1/8" OD SS flanking flavor spout tubes (B0F87V8XCB above) so pump-side flavor flow contacts PE rather than the SS spout wall, simplifying cleaning; ~6" per spout × 2 spouts ≈ 1 ft total per build, well inside the 1 m roll; order 114-9634716-3126657, Apr 29, 2026, $7.49 line + $0.54 tax = $8.03 delivered | 1 | $8.03 | $8.03 |
...
| [Westbrass R2031-NL-62 8" Touch-Flo dispenser faucet, matte black](https://www.amazon.com/dp/B07KH285GJ) | B07KH285GJ — direct successor to retired A2031 SKU; R2031-NL-12 (oil-rubbed bronze, ASIN B01N5LVNQA) is an interchangeable substitute — same R2031-NL family with identical mechanism + black plastic handle, finish is fully hidden by the touch-flo-shell, so pick whichever is cheaper / Prime-available at acquisition time | 1 | $31.28 | $31.28 |
...
| Part | ASIN / Source | Qty | Unit $ | Line $ |
|---|---|---:|---:|---:|
| [ruthex M3 Threaded Inserts Short, 100 pc, RX-M3Sx4.0 brass heat-set](https://www.amazon.com/dp/B0D39W228K) | B0D39W228K — M3 × 4 mm L × 4.2 mm OD knurled brass; 2 into touch-flo-shell + 12 into foam-bag-shell outer_shell (6 top face + 6 bottom face) + 12 into the two reservoir bodies (6 per cap × 2 reservoirs); Amazon order 112-4234665-4274626, May 10, 2026, $9.99 + $0.72 allocated tax = $10.71 delivered ÷ 100 = $0.1071/insert | 26 (of 100 pk) | $0.11 | $2.78 |
