...
- **AC-4/5/6** — not cut here. These are the three conductors of one 18 AWG SJOOW jacketed lead ([~400 mm](SHROUD_LEAD_LEN)), pre-built at [`wiring.md`](/hardware/assembly/wiring.md) §2 and run whole to the compressor — its switched H forks onto relay #1's NO contact, its N seats in the N Wago's open port, its G rings onto the ground bus.
