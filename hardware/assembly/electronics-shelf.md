...
2. **The BOM still books this shelf's inserts against the cold core's top cap.** [`/hardware/ledger/bom.md`](/hardware/ledger/bom.md) §13 counts them as deck-mount columns of the top foam cap and routes them through [`cold-core.md`](/hardware/assembly/cold-core.md)'s pour. They are bosses of `enclosure-back-top`'s +X wall, pressed at [`enclosure-mechanical.md`](/hardware/assembly/enclosure-mechanical.md) §1 — a different part, a different procedure and a different print. The count and the screws are unchanged; the part they belong to is not. §13 and [`cold-core.md`](/hardware/assembly/cold-core.md) both need the move.
