...
| Wago 221-413 lever-nut connector ×[5](WAGO_COUNT) | per [`/hardware/ledger/bom.md`](/hardware/ledger/bom.md) §11 | Every distribution splice: H / N / G for the mains and + / GND for the [12 V](DC_BUS_V) rails. Each presses butt-first into a well printed on the enclosure's own +X wall — there is no carrier part and nothing bolts them. Each carries one in-leg and two out-legs. |
