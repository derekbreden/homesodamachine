...
- **UART hops** — one 4-pin XH header on the ESP32 with its shelf-side end seated and its off-shelf end left open for system integration. SIG-7 carries the ESP32 UART (GPIO 15 TX / 34 RX) to the TTL-to-RS485 transceiver, then RS485 + 12 V + GND to the front-face ESP32-S3-Touch-LCD-4.3B per [`/hardware/printed-parts/enclosure/front-panel/README.md`](/hardware/printed-parts/enclosure/front-panel/README.md).
