...
| L298N Dual H-Bridge | B0C5JCF5RS (1 of 4-pack) | Drives both Kamoer peristaltic pumps from MCP23017-adjacent ESP32 GPIO; the pumps connect via quick-disconnect spades on the pump leads. Its onboard 7805/78M05 makes the 5 V logic rail (MCUs + relay VCC). |
