...
The production procedure for the appliance's electronics shelf — the bench-built Zone-B assembly behind the rear-panel C14 inlet: the controller PCBA, the Mean Well PSU, both Teyleten relay modules, the AC + DC distribution, and the ground bus, across two printed trays. The trays are the committed CAD under [`/hardware/printed-parts/electronics/`](/hardware/printed-parts/electronics/) ([pcba-tray](/hardware/printed-parts/electronics/pcba-tray/), [power-tray](/hardware/printed-parts/electronics/power-tray/)). Feeds [`enclosure-mechanical.md`](/hardware/assembly/enclosure-mechanical.md) alongside [`faucet-and-umbilical.md`](/hardware/assembly/faucet-and-umbilical.md).
...
| 18 AWG stranded hookup wire | per [`/hardware/ledger/bom.md`](/hardware/ledger/bom.md) §11 | AC branch stock (AC-2 through AC-6). |
