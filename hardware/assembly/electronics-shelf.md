...
In: the controller PCBA, the Teyleten 3.3 V opto-isolated relays ×2, the Mean Well IRM-90-12ST PSU, Wago 221-413 lever blocks ×[5](WAGO_COUNT) for the AC and 12 V distribution, the solid-copper ground bus (ring-terminal stack), 16 AWG appliance wire + 22 AWG hookup wire + crimp ferrules/forks/rings, and the RELAYS J5 loom from [`cable-assemblies.md`](/hardware/assembly/cable-assemblies.md).
