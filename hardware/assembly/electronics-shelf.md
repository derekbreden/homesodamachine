...
The production procedure for the appliance's electronics shelf — the bench-built stack that seats on the pump-2 column beside the right-side-panel C14 inlet: the controller PCBA, the Mean Well PSU, both Teyleten relay modules, the AC + DC distribution, and the ground bus, across two printed trays. The trays are the committed CAD under [`/hardware/printed-parts/electronics/`](/hardware/printed-parts/electronics/) ([pcba-tray](/hardware/printed-parts/electronics/pcba-tray/), [power-tray](/hardware/printed-parts/electronics/power-tray/)). Feeds [`enclosure-mechanical.md`](/hardware/assembly/enclosure-mechanical.md) alongside [`faucet-and-umbilical.md`](/hardware/assembly/faucet-and-umbilical.md).
