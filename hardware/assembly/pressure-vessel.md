...
Close one end of the tube with the bottom plate, float rod sticking up into what will become the interior. Recorded practice settings: power 60 %, wobble 80 Hz × 2 mm, wire feed 12 mm/s, argon 2 s pre/post, ER316L .030 filler, 8-tack opposite-side-bisecting pattern, trail-off motion at end of bead, joint surfaces prepped per above. End-to-end qualification on the 316L production joint is open; these settings are not the jet-cap recipe. Wire-stick handling: keep the trigger held and lift straight up at end of bead — the retract/patch cycle fires after conductance breaks in mid-air ([`/marketing/video/dont-let-go.md`](/marketing/video/dont-let-go.md)).
