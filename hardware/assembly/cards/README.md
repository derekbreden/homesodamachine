...
- `img/` — every picture a card shows, cut by
  [`../scenes/render_scenes.py`](/hardware/assembly/scenes/render_scenes.py) through
...
bench, with the box standing — and what it carries that the tables give
