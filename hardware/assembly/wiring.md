...
- **SIG-1** — 1-wire temperature bus, [22 AWG](AWG_DC_BRANCH), [~600 mm](SIG_COLD_CORE_LEN) to the back of the cold core. A DS18B20 (tank-wall, family 0x28) and a DS18S20 (evap-suction, family 0x10) are bussed in parallel on the one bus and told apart in firmware by family code ([`/hardware/wiring/esp32-pinout.mmd`](/hardware/wiring/esp32-pinout.mmd) "Refrigeration"). [4.7 kΩ](PULLUP_R) pull-up between data and [3.3 V](MCU_V) at the ESP32 end. Probes land at the cold core's exit per [`cold-core.md`](/hardware/assembly/cold-core.md).
