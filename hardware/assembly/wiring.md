...
- **I2C J8 loom** — **SIG-8**: the off-board MPR121 cap-sense controller (0x5A) beside the flavor-tube sleeves at the manifold (`GND` / `3V3` / `SDA` / `SCL`), [24 AWG](AWG_SIGNAL). The only off-board I²C device; the bus pull-ups are on the board (R19/R20).
