...
mcp_reservoirs_addr = 0x21  # MCP23017: 4 valves PA[4:7] + cond-fan PA3 -> TBD62083 U5; Rsvr B reeds PB[0:3], carbonator reeds PB[4:5]
...
valve_count = 12            # Beduan solenoids: 8 on 0x20 + 4 on 0x21 → TBD62083 U4/U5
