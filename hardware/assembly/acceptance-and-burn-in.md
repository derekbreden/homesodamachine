...
|---|---|---|
| Test-rig water source | Bench cold-water tap, regulated [40–80 PSI](WATER_PRESS_RANGE), terminated in 1/4" LLDPE pushed into the appliance's rear-panel PP1208E 1/4" JG QC inlet | Stands in for the customer's under-sink supply line. Cold (≤ [~20 °C](WATER_TEMP_MAX)) so the carbonator's first chill-down matches real-world conditions. |
