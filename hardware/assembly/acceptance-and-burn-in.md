...
- **Measure the ASSE drip pan's tab at the start of the window and again at the end.** The tray lies in its sleeve held home by its dock's magnets and nothing else — the sleeve's floor carries it, the lid holds it down, the backstop stops it going in, and west through the wall's slot is left open because that is the way it comes out. So the one thing holding it against westward travel is a magnet pair across a slip, and the tray's own west end standing proud of the skin is what reads it: a tray that has walked stands further out than it did. A walk of any size has parted the pads from the pins, and open pads read as a dry pan — so a drift here is a telltale that has quietly stopped watching, before it is a plate the vent no longer drips on. Log the figure both times.
