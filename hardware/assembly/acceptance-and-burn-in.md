...
| Test-rig CO2 source | [5 lb](CO2_CYL_SMALL) or [10 lb](CO2_CYL_LARGE) CO2 cylinder + CGA-320 primary regulator set to [70–100 PSI](CO2_PRIMARY_RANGE) + MI4508F4SLF flare adapter and red 1/4" LLDPE into the ABU44 bulkhead on the +Y wall | Stands in for the customer's CO2 bottle; the CGA-320 primary regulator ships with the appliance. The in-appliance WR1110 caps the appliance side at [90 PSI](CO2_CENTERLINE) regardless of where the primary is set; setting the primary anywhere in [70–100 PSI](CO2_PRIMARY_RANGE) is the same test. |
