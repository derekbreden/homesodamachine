...
| Test-rig CO2 source | 5 lb or 10 lb CO2 cylinder + CGA-320 primary regulator set to 70–100 PSI + 5/16" beer line into the DERPIPE front-panel bulkhead | Stands in for the customer's CO2 bottle + primary regulator. The in-appliance WR1110 holds the appliance-side 90 PSI regardless of where the primary is set; setting the primary anywhere in 70–100 PSI is the same test. |
