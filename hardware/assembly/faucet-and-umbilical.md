...
| Touch-Flo TPU O-ring (printed) | [`../printed-parts/faucet/touch-flo-tpu-o-ring/`](../printed-parts/faucet/touch-flo-tpu-o-ring/) | Ø 10.2 × Ø 9.45 × 8 mm TPU 90A sealing bushing that seats in the harvested Westbrass body's Ø 10 mm top water port, sealing the 3/8" OD LLDPE dispense tube where it descends from the printed gooseneck into the body. Outer 0.1 mm radial compression seals against the port wall; inner 0.0375 mm radial interference grips the LLDPE. Replaces the factory metal dispense tube + two rubber o-rings; the printed gooseneck is the 3/8" LLDPE's path from the body up to the dispense tip. Install order: bushing into the port first, then push the 3/8" LLDPE down through the bushing's ID. Consumable — expect to use a fresh bushing on any future re-assembly. |
