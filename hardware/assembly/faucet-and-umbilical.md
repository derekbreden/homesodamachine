...
| Cable sleeve — spiral wrap, 1" nominal | Per [`/hardware/printed-parts/enclosure/back-panel/README.md`](/hardware/printed-parts/enclosure/back-panel/README.md) "Umbilical bundle construction"; SKU not yet in `bom.md` | Single sleeve over all three tubes + the signal cable from just above the under-counter plate down to ~3" above the rear-panel bulkheads. ~2.5–3 m per build. Spiral, not braid: both ends are terminated before it goes on |
