...
| Monoprice NEMA 5-15P → IEC C13 line cord, 18 AWG, 6 ft, UL-listed | B08VS8D4WC, 1 of 6 pk per appliance | [`/hardware/ledger/bom.md`](/hardware/ledger/bom.md) §1. Standard US wall outlet to C14 inlet. |
...
- **NEMA 5-15P → C13 line cord** ([`/hardware/ledger/bom.md`](/hardware/ledger/bom.md) §1): 6 ft, UL-listed Monoprice B08VS8D4WC. Laid flat at the bottom of the kit box.
