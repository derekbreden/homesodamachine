...
| Bagged faucet-and-umbilical sub-assembly | Output of [`faucet-and-umbilical.md`](faucet-and-umbilical.md) | Drops into the carton alongside the appliance; ships loose for the customer to install on the countertop. |
