...
Mount the signed plate into its pocket on the rear wall and draw the two M3×8 cap screws down into the heat-sets in the wall's own bosses, one at each end of the plate on its horizontal centreline. The heads land in the plate's counterbores and come out flush with the wall. Apply the signature first and mount second — a plate in its pocket cannot be signed in place.
...
- **Rear wall.** Full-face framing, the signed plate centred in frame, its serial and its link readable from the photo. Good light at the plate face so the contrast-inlay text reads cleanly; the signature must be legible.
...
- Rear-wall nameplate screwed on with this unit's serial, its link, and this unit's hand-applied (or laser-engraved) signature
