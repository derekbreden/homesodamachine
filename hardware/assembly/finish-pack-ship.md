...
- **In-transit sloshing.** A ground freight carton at [20 kg](SLOSH_CARTON_W) sees aggressive handling — drops from chest height, stacking under heavier cartons, rough-roll-cage loading at the regional sort facility. Liquid in the carbonator at transit accelerates the load on the welded plate-to-tube joints and risks unseating the magnetic donut float from its rod register at the bottom plate.
...
- **Lighter shipping weight.** [~1.5 kg](WATER_DRAINED) of water + [~1 kg](FLAVOR_DRAINED) of flavor concentrate between the two reservoirs, removed at the dry-ship decision. The carrier cost model thanks us.
