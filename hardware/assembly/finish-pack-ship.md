...
- Carton sealed with appliance + bagged faucet-and-umbilical sub-assembly + install kit (the cold kit inside it) + customer documentation packet, the quick start lying on top of all of it
