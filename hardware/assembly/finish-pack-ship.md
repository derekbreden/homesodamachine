...
- The compressor sitting square on its four floor posts, every washer home on its post's crown with the grommet under it visibly taken up and not squashed flat; the green ring on the can's own earth screw, and the AC lead's jacket unbroken back to the shelf.
