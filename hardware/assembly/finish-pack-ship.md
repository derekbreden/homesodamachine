...
- **The customer's plumbing** (§3, §4): the tee subassembly — PP0208E, jumper, and the coiled white run with its filter and `TAP` collar; the bagged John Guest ASVPP1LF beside it; the red tether with its flare connector and `CO2` collar. These are what the quick start's steps 5 and 6 push.
