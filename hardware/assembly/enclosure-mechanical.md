...
| CO2 DERPIPE PTC | [x -8.28, z 336.2](CO2_BACK) | Ø[15.42](CO2_HOLE_D) round | Seated on its own inboard stub tip; the GASHER check threads onto that stub in [`internal-plumbing.md`](/hardware/assembly/internal-plumbing.md) |
...
The card's own reading of the chassis at this point: [76](BODY_COUNT) bodies placed, the pack closing with no two solids sharing volume, and every printed piece on the bed.
