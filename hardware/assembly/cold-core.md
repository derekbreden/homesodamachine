...
| ruthex M3 short heat-set inserts × [32](CC_INSERTS) — every one this procedure presses ([20](CAP_INSERTS) foam-caps: [12](CAP_CLAMP_INSERTS) clamp bosses plus [8](CAP_DECK_INSERTS) deck-mount columns, + [12](RES_INSERTS) reservoir). The touch-flo plate's and the power column's are pressed elsewhere; `bom.md` §13 carries the appliance total | ruthex B0D39W228K (100-pc bag) | ON-ORDER |
