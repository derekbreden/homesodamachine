...
- **PRV shroud** ([`../printed-parts/cold-core/prv-shroud/`](../printed-parts/cold-core/prv-shroud/)) slipped over the SV-125 valve, seated on the TAISHER elbow's smooth ⌀18.8 mm cylinder, and sealed at the elbow joint per the shroud README. **Prerequisite:** PRV pull-ring tested free per [`pressure-vessel.md`](pressure-vessel.md) step 9 — once the shroud goes on, the pull-ring is permanently inaccessible.
