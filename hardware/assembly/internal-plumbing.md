...
Cut a second length of 1/4" OD LLDPE from the filter outlet QC to the upstream adapter chain (1/4" PTC → 3/8" FNPT, SKU pending in [`../purchases.md`](../purchases.md) LIKELY-TO-BUY). Square cuts, push fully, tug-test. Thread the adapter chain onto the ASSE 1022's 3/8" MPT inlet with PTFE tape (2–3 wraps, clockwise into the thread, first thread tape-free). Snug + 1 turn past hand-tight. Multiplex flow arrow points away from the customer side (inflow from the adapter chain at the 3/8" MPT side, outflow toward the SeaFlo pump at the 3/8" MFL side).
...
- Water path closed dry from the back-panel PI1208S 1/4" JG QC bulkhead through the Waterdrop 15UC-UF filter (placement TBD), the upstream adapter chain, the Multiplex 19-0897 ASSE 1022 backflow preventer, the brewhardware FFL38BARB38 on its MFL outlet, the JoyTube silicone hose (LOKMAN clamps both ends), the SeaFlo pump, MAACFLOW barb adapter, GASHER check, first PP010822E, into the cold-core water-inlet
