...
| Printed pump cartridge | `../printed-parts/flavor/pump-case/` | Holds both Kamoer pumps + pogo-pin electrical interface; tool-free swap from the top of Zone C, beneath the funnel, per [`../printed-parts/zone-c/README.md`](../printed-parts/zone-c/README.md) |
...
Cartridge install method into the enclosure is **TBD; see Open items**. The cartridge has been designed for tool-free swap from the top of Zone C, beneath the funnel, per [`../printed-parts/zone-c/README.md`](../printed-parts/zone-c/README.md); the exact mechanism (push-fit + detent, screwed mounting plate, latch + cam) is not specified in the parts already committed.
