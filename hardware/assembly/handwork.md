...
Companion to [bom.md](../ledger/bom.md) (per-unit parts) and [purchases.md](../ledger/purchases.md) (every dollar out, with founder time explicitly excluded — "sweat equity, un-booked by design").
