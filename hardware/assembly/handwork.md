...
Join the 1/4"-thick 316L end-cap plates to the 5" OD × 0.065" wall 316L tube ends with the XLaserlab X1 Pro handheld laser welder, STARTECHWELD ER316L .030 filler (matches the 316L parent metal — undermatching with 308L would lose the molybdenum across the joint). Top + bottom plates per carbonator × 10 carbonators of stock. The 1/8" 316L float rod (Tandefio B0CY4DWJFQ, cut to [131.1 mm (5.16 in)](ROD_LEN)) tack-welds vertically to the inside face of the bottom plate as part of this same operation, before the bottom-plate-to-tube weld closes the carbonator ([future.md](/hardware/future.md) "Level sensing").
