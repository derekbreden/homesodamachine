...
Read the donor compressor nameplate — refrigerant type (must be R-600a) and charge mass. The two donors tracked in [`../harvested/ice-maker/README.md`](../harvested/ice-maker/README.md) are both R-600a; the exact charge mass is per-unit open until the nameplate is fully exposed.
