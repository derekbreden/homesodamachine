...
SHELF_SYNC = ROOT / "hardware/assembly/_electronics_bay_sync.py"
...
# Hardware carries no signal. The pump cartridge and both display cover plates are
...
# holds the glass in its facet is a load. Either facet's border reads the same, so
# the term takes both. The displays themselves are on the CROSS table.
NO_PIN = (r"ESP32-WROOM|MCP23017|DS3231|Mean Well|DIN 912"
          r"|pump cartridge|[Dd]isplay cover plate")
