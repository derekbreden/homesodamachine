...
[`internal-plumbing.md`](/hardware/assembly/internal-plumbing.md) §3 begins before enclosure closure because `enclosure-front-top` is the assembly fixture. Its order is bare tees loaded into the tee wall's journals; left carrier half entered through the rear, lowered behind the tees and seated outward on the aft stop; right half entered the same way onto the left half's tongue, the full-height lap closed with two M3 screws from the open rear; carrier moved to release; aft valves raised from the underside and pressed into their sockets; two ties per tee; compressed springs fed down beside the outer tees and through the windows into the service tabs' channels; fore valves and four bowed flex stubs. After the box closes, squeeze to bottom the tubes with the cartridge 2.15 mm short of seating, then relax the grips and push the cartridge through that final stroke. The rest of internal plumbing follows [`enclosure-mechanical.md`](/hardware/assembly/enclosure-mechanical.md), and [`wiring.md`](/hardware/assembly/wiring.md) takes a chassis that already carries its plumbing. The card deck in [`/hardware/assembly/cards/`](/hardware/assembly/cards/) prints in this order.
