...
The selected diaphragm pump is the received [G Ganen sample](/hardware/reference/pump-comparison/README.md); its scan-derived reference and enclosure integration are in progress. The generated assembly still carries the SeaFlo reference and remains unreleased for printing. The Mean Well IRM-90-12ST supply is the current reference. The [water-inlet jet](/hardware/assembly/water-inlet-jet.md) is a drilled 316 cap welded onto the existing elbow's male tip; its fit and full root fusion require physical qualification. [Acceptance and burn-in](/hardware/assembly/acceptance-and-burn-in.md) establish actual refill, restart and first- and successive-glass performance. [Carbonation Plan B](/future/carbonation-plan-b.md) maps a measured shortfall to a conditional change.
