...
A TPU face seal sits on each floor face, each sized to its flange: a **wet ⌀[21 mm](BULKHEAD_SEAL_WET_OD)** washer under the ⌀[21.9 mm](BULKHEAD_WET_NUT_OD) nut face (`reservoir-bulkhead-seal-wet.step`) and a narrow **dry ⌀[18.5 mm](BULKHEAD_SEAL_DRY_OD)** washer under the ⌀[18.7 mm](BULKHEAD_DRY_FLANGE_OD) flange (`reservoir-bulkhead-seal-dry.step`). The below-floor stack (elbow + clearance) is detailed in `../../printed-parts/cold-core/reservoir/floor-and-bulkhead.md`.
...
| Washer OD (wet) | [21 mm](BULKHEAD_SEAL_WET_OD) | `bulkhead_seal_wet_od` |
| Washer OD (dry) | [18.5 mm](BULKHEAD_SEAL_DRY_OD) | `bulkhead_seal_dry_od` |
| Washer thickness ([30%](BULKHEAD_SEAL_COMPRESSION) compression) | [2 mm](BULKHEAD_SEAL_THICKNESS) | `bulkhead_seal_thickness` |
| Counterbore ⌀ (wet) | [21.2 mm](BULKHEAD_SEAL_WET_CB_D) | `bulkhead_seal_wet_counterbore_diameter` |
...
The wet seal is the primary: ⌀[21 mm](BULKHEAD_SEAL_WET_OD) washer under the ⌀[21.9 mm](BULKHEAD_WET_NUT_OD) nut face. The dry seal is flange-limited: the ⌀[18.7 mm](BULKHEAD_DRY_FLANGE_OD) elbow flange caps it at a ⌀[18.5 mm](BULKHEAD_SEAL_DRY_OD) washer on a narrow PETG rim.

## Panel Clamp

The threaded barrel is ~10 mm long. The locknut needs ~4–5 mm of thread engagement, giving a clampable panel stack of ~5–6 mm. The reservoir floor is [3 mm](RESERVOIR_WALL_T) PETG; the clamped stack is that floor plus the [1.4 mm](BULKHEAD_SEAL_CB_DEPTH)-compressed TPU washer. The nut seats on the wet face, the flange on the dry face, the [3 mm](RESERVOIR_WALL_T) floor between them.
