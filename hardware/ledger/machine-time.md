...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [5.942](MT_KG_BULK) kg | [64.2](MT_H_BULK) |
...
| **Printer time per unit** | | | **[7.059](MT_KG)** kg | **[95.5](MT_H_PRINT)** |
