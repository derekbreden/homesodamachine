...
| Small PETG parts | Valve trays, drip pan, plug stack, PRV shroud, AC hub plate, reed bridge | [30](MT_RATE_SMALL) h/kg — est., travel and layer-change overhead dominate a small part | [0.227](MT_KG_SMALL) kg | [6.8](MT_H_SMALL) |
...
| **Printer time per unit** | | | **[7.288](MT_KG)** kg | **[100.9](MT_H_PRINT)** |
...
|---|---:|---:|---|
| [2](MT_PRINTERS) × H2C | [50.5](MT_H_PRINT_WALL) h wall | [174](MT_CEIL_PRINT) | **the bottleneck** |
