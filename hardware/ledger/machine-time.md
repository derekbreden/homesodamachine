...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, the enclosure's four quadrants and its pump cartridge, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [7.353](MT_KG_BULK) kg | [79.4](MT_H_BULK) |
...
| **Printer time per unit** | | | **[8.523](MT_KG)** kg | **[112.4](MT_H_PRINT)** |
