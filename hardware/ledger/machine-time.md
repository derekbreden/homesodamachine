...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [6.064](MT_KG_BULK) kg | [65.5](MT_H_BULK) |
...
| **Printer time per unit** | | | **[7.181](MT_KG)** kg | **[96.9](MT_H_PRINT)** |
...
At [65 %](MT_DUTY) machine duty — failed prints, plate changes, filament swaps, maintenance, the hours nobody is in the shop to restart a plate — the printers give **[~118](MT_UNITS_YEAR) units a year**. A third H2C moves that to [~176](MT_UNITS_YEAR_3); nothing else bought moves it at all.
