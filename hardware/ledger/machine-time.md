...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, the enclosure's four quadrants and its pump cartridge, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [7.590](MT_KG_BULK) kg | [82.0](MT_H_BULK) |
...
| **Printer time per unit** | | | **[8.760](MT_KG)** kg | **[114.9](MT_H_PRINT)** |
