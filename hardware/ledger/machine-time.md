...
| Enclosure exterior PETG, 0.4 High Flow | The four quadrants, the pump cartridge and its cap — the show surfaces, printed at the finish the box is judged on ([enclosure/print-log.md](/hardware/printed-parts/enclosure/enclosure/print-log.md)) | [9.1](MT_RATE_EXT) h/kg — **measured** | [6.259](MT_KG_EXT) kg | [57.0](MT_H_EXT) |
...
| **Printer time per unit** | | | **[9.415](MT_KG)** kg | **[112.0](MT_H_PRINT)** |
...
At [65 %](MT_DUTY) machine duty — failed prints, plate changes, filament swaps, maintenance, the hours nobody is in the shop to restart a plate — the printers give **[~101](MT_UNITS_YEAR) units a year**. A third H2C moves that to [~153](MT_UNITS_YEAR_3); nothing else bought moves it at all.
