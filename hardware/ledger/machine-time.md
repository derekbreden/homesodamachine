...
| **Printer time per unit** | | | **[9.643](MT_KG)** kg | **[114.1](MT_H_PRINT)** |
...
|---|---:|---:|---|
| [2](MT_PRINTERS) × H2C | [57.1](MT_H_PRINT_WALL) h wall | [154](MT_CEIL_PRINT) | **the bottleneck** |
...
At [65 %](MT_DUTY) machine duty — failed prints, plate changes, filament swaps, maintenance, the hours nobody is in the shop to restart a plate — the printers give **[~100](MT_UNITS_YEAR) units a year**. A third H2C moves that to [~150](MT_UNITS_YEAR_3); nothing else bought moves it at all.
