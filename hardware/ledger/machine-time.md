...
| **Printer time per unit** | | | **[7.015](MT_KG)** kg | **[178.4](MT_H_PRINT)** |

Spread across [2](MT_PRINTERS) machines that is **[89.2](MT_H_PRINT_WALL) hours** of wall clock, and it is the longest pole in the build by an order of magnitude.
...
|---|---:|---:|---|
| [2](MT_PRINTERS) × H2C | [89.2](MT_H_PRINT_WALL) h wall | [98](MT_CEIL_PRINT) | **the bottleneck** |
...
| Stage | Hours | |
|---|---:|---|
| Print every part | [89.2](MT_H_PRINT_WALL) | 2 printers, both on this unit |
...
| Burn-in | 8.0 | |
| Finish and pack | 1.0 | |
| **Turnaround** | **[117.2](MT_H_TURN)** | **[4.9](MT_DAYS_TURN) days** |
...
A second unit behind the first does not cost another [4.9](MT_DAYS_TURN) days — it costs the bottleneck's [89.2](MT_H_PRINT_WALL) hours, since its prints start the moment the first unit's come off the plates.
