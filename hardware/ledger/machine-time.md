...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [6.279](MT_KG_BULK) kg | [67.8](MT_H_BULK) |
...
| **Printer time per unit** | | | **[7.436](MT_KG)** kg | **[100.4](MT_H_PRINT)** |
