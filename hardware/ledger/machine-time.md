...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [6.012](MT_KG_BULK) kg | [64.9](MT_H_BULK) |
...
| Small PETG parts | Valve trays, drip pan, plug stack, PRV shroud, AC hub plate, reed bridge | [30](MT_RATE_SMALL) h/kg — est., travel and layer-change overhead dominate a small part | [0.224](MT_KG_SMALL) kg | [6.7](MT_H_SMALL) |
...
| **Printer time per unit** | | | **[7.279](MT_KG)** kg | **[100.8](MT_H_PRINT)** |
