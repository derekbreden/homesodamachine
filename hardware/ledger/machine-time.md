...
| Faucet PET-GF, 0.4 TC | Faucet shell, its display cover plate and the above-counter plate — four pieces on one plate, 0.24 mm layers, two wall loops and 15 % grid ([faucet-petgf.md](/hardware/printed-parts/faucet/faucet-petgf.md)) | [58.9](MT_RATE_PETGF) h/kg — duration from saved-profile slice | [0.140](MT_KG_PETGF) kg | [8.2](MT_H_PETGF) |
| **Printer time per unit** | | | **[6.963](MT_KG)** kg | **[172.0](MT_H_PRINT)** |

Spread across [2](MT_PRINTERS) machines that is **[86.0](MT_H_PRINT_WALL) hours** of wall clock, and it is the longest pole in the build by an order of magnitude.
...
|---|---:|---:|---|
| [2](MT_PRINTERS) × H2C | [86.0](MT_H_PRINT_WALL) h wall | [102](MT_CEIL_PRINT) | **the bottleneck** |
...
| Stage | Hours | |
|---|---:|---|
| Print every part | [86.0](MT_H_PRINT_WALL) | 2 printers, both on this unit |
...
| Burn-in | 8.0 | |
| Finish and pack | 1.0 | |
| **Turnaround** | **[114.0](MT_H_TURN)** | **[4.7](MT_DAYS_TURN) days** |
...
A second unit behind the first does not cost another [4.7](MT_DAYS_TURN) days — it costs the bottleneck's [86.0](MT_H_PRINT_WALL) hours, since its prints start the moment the first unit's come off the plates.
