...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [5.834](MT_KG_BULK) kg | [63.0](MT_H_BULK) |
...
| **Printer time per unit** | | | **[6.949](MT_KG)** kg | **[94.3](MT_H_PRINT)** |
