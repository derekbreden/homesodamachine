...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, the enclosure's four quadrants and its pump cartridge, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [7.528](MT_KG_BULK) kg | [81.3](MT_H_BULK) |
...
| **Printer time per unit** | | | **[8.698](MT_KG)** kg | **[114.3](MT_H_PRINT)** |
...
At [65 %](MT_DUTY) machine duty — failed prints, plate changes, filament swaps, maintenance, the hours nobody is in the shop to restart a plate — the printers give **[~99](MT_UNITS_YEAR) units a year**. A third H2C moves that to [~150](MT_UNITS_YEAR_3); nothing else bought moves it at all.
