...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [5.813](MT_KG_BULK) kg | [62.8](MT_H_BULK) |
...
| **Printer time per unit** | | | **[6.928](MT_KG)** kg | **[94.1](MT_H_PRINT)** |
...
|---|---:|---:|---|
| [2](MT_PRINTERS) × H2C | [47.0](MT_H_PRINT_WALL) h wall | [186](MT_CEIL_PRINT) | **the bottleneck** |
...
At [65 %](MT_DUTY) machine duty — failed prints, plate changes, filament swaps, maintenance, the hours nobody is in the shop to restart a plate — the printers give **[~121](MT_UNITS_YEAR) units a year**. A third H2C moves that to [~182](MT_UNITS_YEAR_3); nothing else bought moves it at all.
