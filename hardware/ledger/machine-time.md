...
| Enclosure exterior PETG, 0.4 High Flow | The four quadrants, the pump cartridge and its cap — the show surfaces, printed at the finish the box is judged on ([enclosure/print-log.md](/hardware/printed-parts/enclosure/enclosure/print-log.md)) | [9.1](MT_RATE_EXT) h/kg — **measured** | [6.476](MT_KG_EXT) kg | [58.9](MT_H_EXT) |
...
| **Printer time per unit** | | | **[9.649](MT_KG)** kg | **[114.3](MT_H_PRINT)** |

Spread across [2](MT_PRINTERS) machines that is **[57.1](MT_H_PRINT_WALL) hours** of wall clock, and it is the longest pole in the build by an order of magnitude.
...
|---|---:|---:|---|
| [2](MT_PRINTERS) × H2C | [57.1](MT_H_PRINT_WALL) h wall | [153](MT_CEIL_PRINT) | **the bottleneck** |
...
At [65 %](MT_DUTY) machine duty — failed prints, plate changes, filament swaps, maintenance, the hours nobody is in the shop to restart a plate — the printers give **[~99](MT_UNITS_YEAR) units a year**. A third H2C moves that to [~149](MT_UNITS_YEAR_3); nothing else bought moves it at all.
