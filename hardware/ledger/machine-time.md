...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [6.018](MT_KG_BULK) kg | [65.0](MT_H_BULK) |
...
| Small PETG parts | Valve trays, drip pan, plug stack, PRV shroud, AC hub plate, reed bridge | [30](MT_RATE_SMALL) h/kg — est., travel and layer-change overhead dominate a small part | [0.219](MT_KG_SMALL) kg | [6.6](MT_H_SMALL) |
...
| **Printer time per unit** | | | **[7.280](MT_KG)** kg | **[100.7](MT_H_PRINT)** |
...
At [65 %](MT_DUTY) machine duty — failed prints, plate changes, filament swaps, maintenance, the hours nobody is in the shop to restart a plate — the printers give **[~113](MT_UNITS_YEAR) units a year**. A third H2C moves that to [~170](MT_UNITS_YEAR_3); nothing else bought moves it at all.
