...
| **Printer time per unit** | | | **[7.035](MT_KG)** kg | **[179.0](MT_H_PRINT)** |
...
At [65 %](MT_DUTY) machine duty — failed prints, plate changes, filament swaps, maintenance, the hours nobody is in the shop to restart a plate — the printers give **[~64](MT_UNITS_YEAR) units a year**. A third H2C moves that to [~95](MT_UNITS_YEAR_3); nothing else bought moves it at all.
