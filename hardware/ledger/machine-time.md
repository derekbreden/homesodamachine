...
| Faucet PET-GF, 0.4 TC | Faucet shell, its display cover plate and the above-counter plate — four pieces on one plate, 0.24 mm layers, two wall loops and 15 % grid ([faucet-petgf.md](/hardware/printed-parts/faucet/faucet-petgf.md)) | [38.6](MT_RATE_PETGF) h/kg — duration from saved-profile slice | [0.116](MT_KG_PETGF) kg | [4.5](MT_H_PETGF) |
| **Printer time per unit** | | | **[6.939](MT_KG)** kg | **[168.2](MT_H_PRINT)** |
