...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [5.798](MT_KG_BULK) kg | [62.6](MT_H_BULK) |
...
| **Printer time per unit** | | | **[6.913](MT_KG)** kg | **[93.9](MT_H_PRINT)** |
