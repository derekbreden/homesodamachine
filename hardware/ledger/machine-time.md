...
| Faucet PET-GF, 0.4 TC | Faucet shell, its display cover plate and the above-counter plate — four pieces on one plate, 0.24 mm layers, two wall loops and 15 % grid ([faucet-petgf.md](/hardware/printed-parts/faucet/faucet-petgf.md)) | [56.6](MT_RATE_PETGF) h/kg — duration from saved-profile slice | [0.142](MT_KG_PETGF) kg | [8.0](MT_H_PETGF) |
