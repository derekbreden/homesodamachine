...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, the enclosure's four quadrants and its pump cartridge, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [7.449](MT_KG_BULK) kg | [80.4](MT_H_BULK) |
...
| **Printer time per unit** | | | **[8.619](MT_KG)** kg | **[113.4](MT_H_PRINT)** |
...
|---|---:|---:|---|
| [2](MT_PRINTERS) × H2C | [56.7](MT_H_PRINT_WALL) h wall | [154](MT_CEIL_PRINT) | **the bottleneck** |
...
At [65 %](MT_DUTY) machine duty — failed prints, plate changes, filament swaps, maintenance, the hours nobody is in the shop to restart a plate — the printers give **[~100](MT_UNITS_YEAR) units a year**. A third H2C moves that to [~151](MT_UNITS_YEAR_3); nothing else bought moves it at all.
