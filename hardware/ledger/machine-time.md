...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [6.020](MT_KG_BULK) kg | [65.0](MT_H_BULK) |
...
| **Printer time per unit** | | | **[7.293](MT_KG)** kg | **[101.1](MT_H_PRINT)** |
