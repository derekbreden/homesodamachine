...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [6.232](MT_KG_BULK) kg | [67.3](MT_H_BULK) |
...
| **Printer time per unit** | | | **[7.389](MT_KG)** kg | **[99.9](MT_H_PRINT)** |
...
|---|---:|---:|---|
| [2](MT_PRINTERS) × H2C | [49.9](MT_H_PRINT_WALL) h wall | [175](MT_CEIL_PRINT) | **the bottleneck** |
