...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [5.297](MT_KG_BULK) kg | [57.2](MT_H_BULK) |
...
| **Printer time per unit** | | | **[6.414](MT_KG)** kg | **[88.6](MT_H_PRINT)** |
