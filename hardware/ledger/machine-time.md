...
| Small PETG parts | Drip pan, plug stack, PRV shroud, reed bridge, fuse clamp | [30](MT_RATE_SMALL) h/kg — est., travel and layer-change overhead dominate a small part | [0.115](MT_KG_SMALL) kg | [3.5](MT_H_SMALL) |
...
| **Printer time per unit** | | | **[6.313](MT_KG)** kg | **[88.3](MT_H_PRINT)** |
...
|---|---:|---:|---|
| [2](MT_PRINTERS) × H2C | [44.1](MT_H_PRINT_WALL) h wall | [198](MT_CEIL_PRINT) | **the bottleneck** |
