...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [5.136](MT_KG_BULK) kg | [55.5](MT_H_BULK) |
...
| Small PETG parts | Drip pan, plug stack, PRV shroud, reed bridge, fuse clamp | [30](MT_RATE_SMALL) h/kg — est., travel and layer-change overhead dominate a small part | [0.080](MT_KG_SMALL) kg | [2.4](MT_H_SMALL) |
...
| **Printer time per unit** | | | **[6.259](MT_KG)** kg | **[87.0](MT_H_PRINT)** |
...
|---|---:|---:|---|
| [2](MT_PRINTERS) × H2C | [43.5](MT_H_PRINT_WALL) h wall | [201](MT_CEIL_PRINT) | **the bottleneck** |
