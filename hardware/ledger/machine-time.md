...
|---|---|---|---:|---:|
| Bulk PETG, 0.8 nozzle | Cold-core shell, both enclosure sets, four foam-cap pieces | [10.8](MT_RATE_BULK) h/kg — **measured** | [5.845](MT_KG_BULK) kg | [63.1](MT_H_BULK) |
...
| **Printer time per unit** | | | **[6.962](MT_KG)** kg | **[94.5](MT_H_PRINT)** |
