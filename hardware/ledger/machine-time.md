...
Spread across [2](MT_PRINTERS) machines that is **[56.5](MT_H_PRINT_WALL) hours** of wall clock, and it is the longest pole in the build by an order of magnitude.
...
|---|---:|---:|---|
| [2](MT_PRINTERS) × H2C | [56.5](MT_H_PRINT_WALL) h wall | [155](MT_CEIL_PRINT) | **the bottleneck** |
...
| Stage | Hours | |
|---|---:|---|
| Print every part | [56.5](MT_H_PRINT_WALL) | 2 printers, both on this unit |
...
| Burn-in | 8.0 | |
| Finish and pack | 1.0 | |
| **Turnaround** | **[84.5](MT_H_TURN)** | **[3.5](MT_DAYS_TURN) days** |
...
A second unit behind the first does not cost another [3.5](MT_DAYS_TURN) days — it costs the bottleneck's [56.5](MT_H_PRINT_WALL) hours, since its prints start the moment the first unit's come off the plates.
