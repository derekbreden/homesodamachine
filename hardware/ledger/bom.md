...
| [Rubycon 470 µF 25 V low-ESR radial electrolytic capacitor, 10×12.5 mm (15-pk)](https://www.amazon.com/dp/B0F8BZVBKF) | bulk (low-frequency) decoupling on the 12 V solenoid rail; on-carrier C3 ([`pcb/carrier/mini.tsx`](/hardware/pcb/carrier/mini.tsx)), a radial in the open valley between the two ULN drivers it feeds, soaking the inrush + flyback dump. pin1 (+)→V12 (the V12 island pour, widened to flood the whole valve block, covers it), pin2→GND plane. Pairs with the on-carrier 0.1 µF HF ceramics (C1/C2 below); 1 of 15 per unit ($7.40/15) | 1 (of 15 pk) | $0.49 | $0.49 |
| [Chanzon 0.1 µF 50 V ceramic disc capacitor, 2.54 mm lead pitch (100-pk)](https://www.amazon.com/dp/B07PTNB3CR) | high-frequency V12-rail decoupling — carrier C1/C2 ([`pcb/carrier/mini.tsx`](/hardware/pcb/carrier/mini.tsx)), two through-hole 0.1 µF set into the right-edge connector stack and centered across the MANIFOLD fence (C2 above the 12 V inlet, C1 below MANIFOLD B), snubbing the fast solenoid-turn-off edge the bulk electrolytic can't. pin1→V12 pour, pin2→GND plane. 2 of 100 per unit | 2 (of 100 pk) | $0.02 | $0.04 |
...
| SendCutSend compressor shroud (`cut-parts/compressor-shroud/`) | 0.059" G90 hot-dipped galvanized steel; 5-sided open-bottom box, interior 130 × 175 × 150 mm, 4 bends; design + rationale at [`cut-parts/compressor-shroud/README.md`](/hardware/cut-parts/compressor-shroud/README.md). SendCutSend quote 2026-06-03: $278.30 / qty 10 = $27.83/part. AC pass-through strain relief listed separately below (SS 1/2"-NPT cable gland) | 1 | $27.83 | $27.83 |
| [GEARit 25 ft 18/3 SJOOW portable cord, 18 AWG 300 V](https://www.amazon.com/dp/B0BKQ2H9BZ) | Rubber-jacketed 3-conductor lead for the compressor-shroud AC pass-through (AC-4/5/6: switched-H + N + G). 25 ft spool, ~400 mm/build. $20.37/25 ft = $0.81/ft | ~1.3 ft | $0.81/ft | $1.06 |
| [Biaungdo 1/2" NPT stainless cable gland, adjustable 6–12 mm (2-pack)](https://www.amazon.com/dp/B0F2HP5FWB) | Strain relief for the compressor-shroud AC pass-through — stainless, 1/2" NPT, 6–12 mm clamping range. $7.63/2 paid | 1 (of 2) | $3.82 | $3.82 |
...
| [Keszoox JST XH 2.54 mm pre-crimped wires, 50 cm × 22 AWG silicone (20 wires/pk, 10 colors)](https://www.amazon.com/dp/B0F8HMQRRN) | Relegated to short module-to-module XH hops where length is non-critical; the length-specific valve/signal runs now use bulk black 22 AWG cut-to-length (below), per [`cable-assemblies.md`](/hardware/assembly/cable-assemblies.md). ~1 pk/unit | 1 pk (of 20 wires) | $11.63 | $11.63 |
...
| [WAGO 221-415 lever-nut, 5-conductor (25 pk)](https://www.amazon.com/dp/B0107SYYGU) | 5-way lever nut for the ≤5-conductor on-board connector fan-outs: J6 REEDS A GND → 4 reeds (5-conductor node), J4 SENSORS GND, J5 DRIVER GND. Not the AC distribution (that's the 221-413 below). 24–12 AWG. $26.76/25 paid; 3/build ([purchases.md](/hardware/ledger/purchases.md) §11) | 3 (of 25 pk) | $1.07 | $3.21 |
| [WAGO 221-413 lever-nut, 3-conductor (box of 50)](https://www.amazon.com/dp/B07W7W91FX) | AC mains distribution on the [power tray](/hardware/printed-parts/electronics/power-tray/) — H / N / G, one nut per pole; the tray's three Wago slots are dimensioned to this part (Kitchen + Lite both, per [lite-bom.md](/pie-in-the-sky/lite/lite-bom.md)). Distinct from the on-board fan-out nuts above; a 221-415 will not fit the 221-413 slots. 24–12 AWG. $27.83/50 paid; 3/build ([purchases.md](/hardware/ledger/purchases.md) §11) | 3 (of 50 box) | $0.56 | $1.67 |
| [BNTECHGO 22 AWG silicone, 250 ft black spool](https://www.amazon.com/dp/B06Y2PNW41) | Bulk all-black cut-to-length hookup for the valve branches (DC-7 fan-out), low-power DC (L298N feed, fan), and the J4/J5 signal runs. Single-color black per the all-black convention — color is reserved for the AC mains only (see [`cable-assemblies.md`](/hardware/assembly/cable-assemblies.md)). Stranded tinned-copper silicone, 600 V. $27.86/250 ft = $0.11/ft | ~15 ft | $0.11/ft | $1.67 |
