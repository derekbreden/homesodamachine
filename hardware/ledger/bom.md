...
| [Rubycon 470 µF 25 V low-ESR radial electrolytic capacitor, 10×12.5 mm (15-pk)](https://www.amazon.com/dp/B0F8BZVBKF) | bulk (low-frequency) decoupling on the 12 V solenoid rail; on-carrier C3 ([`pcb/carrier/mini.tsx`](/hardware/pcb/carrier/mini.tsx)), a radial in the open valley between the two ULN drivers it feeds, soaking the inrush + flyback dump. pin1 (+)→V12 (a finger of the island pour reaches it), pin2→GND plane. Pairs with the on-carrier 0.1 µF HF ceramics (C1/C2 below); 1 of 15 per unit ($7.40/15) | 1 (of 15 pk) | $0.49 | $0.49 |
