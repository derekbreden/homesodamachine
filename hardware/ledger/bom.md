...
| [Wago 221-413 lever-nut, 3-conductor](/hardware/reference/wago-221-413/) | AC mains distribution on the [power tray](/hardware/printed-parts/electronics/power-tray/) — H / N / G, one nut per pole; the tray's three Wago slots are dimensioned to this part (Kitchen + Lite both, per [lite-bom.md](/pie-in-the-sky/lite/lite-bom.md)). Distinct from the on-board fan-out nuts above; a 221-415 will not fit the 221-413 slots. 3/build; not yet ordered, ~$0.85 ea at 10-pk | 3 | $0.85 | $2.55 |
