...
| [WAGO 221-415 lever-nut, 5-conductor (25 pk)](https://www.amazon.com/dp/B0107SYYGU) | 5-way lever nut for the ≤5-conductor fan-outs: J6 REEDS A GND → 4 reeds (5-conductor node), J4 SENSORS GND, J5 DRIVER GND, plus the AC distribution block (H, N, G — one nut per pole). 24–12 AWG. $26.76/25 paid; ~6/build ([purchases.md](/hardware/ledger/purchases.md) §11) | 6 (of 25 pk) | $1.07 | $6.42 |
