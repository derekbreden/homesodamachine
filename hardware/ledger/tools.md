...
| Tool | Source | Notes | $ |
|---|---|---|---:|
| **PB Motor Tech 5-gal stainless vacuum chamber** | [B0D78ZM928](https://www.amazon.com/dp/B0D78ZM928), [purchases.md §21](/hardware/ledger/purchases.md) | 18.9 L, 11.8" × 11.8" interior, tempered-glass lid, glycerin gauge, shutoff valve. Degassing the platinum-silicone funnel pours. Has no pump of its own — it mates the §6 Orion 4 CFM pump (T_VAC_PUMP) over 1/4" SAE flare, so a refrigerant evacuation and a silicone degas compete for one pump. Cup sizing assumes the 3–4× rise of a ~70 mL pour. | [$102.95](T_VAC_CHAMBER) |
