...
takes under its left nozzle, [315 × 310 mm](FCT_SLAB) across and [220 mm](FCT_HEIGHT) tall,
...
nothing needs support, and the plate's texture is the counter's surface. The slab's edges
