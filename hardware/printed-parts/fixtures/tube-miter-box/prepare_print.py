"""Prepare the tube miter box from the shared PET-GF settings; offline only.
...
STL = HERE / "tube-miter-box.stl"

VARIANTS = {
    "black-h2c": {"project": "tube-miter-box-petgf.3mf",
                  "archive": "tube-miter-box-petgf-z018-h2c.gcode.3mf",
                  "z_trim": 0.18, "title": "Tube miter box black PET-GF H2C"},
    "black-mark2": {"project": "tube-miter-box-petgf-mark2.3mf",
                    "archive": "tube-miter-box-petgf-z004-mark2.gcode.3mf",
                    "z_trim": 0.04, "title": "Tube miter box black PET-GF Mark2"},
}
...
def prepare(variant):
    ...
    report["pose"] = "bottom face on the bed, troughs open upward; no support"
