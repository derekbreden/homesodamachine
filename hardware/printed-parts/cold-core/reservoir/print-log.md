...
Hardware change before this print: right-side nozzle swapped from 0.8 mm to 0.6 mm. Printer/print profile retargeted accordingly (`@BBL H2C 0.8 nozzle` → `@BBL H2C 0.6 nozzle`); `nozzle_diameter` 0.8 → 0.6 mm.
