...
def build_full_shell():
    ...
    # shell does — the outer shell, the carbonator support ring and the reed channels all fence a
    ...
    foam_shell = (
        pocket_walls
        .union(corner_posts)
        .union(build_carbonator_support_ring())
