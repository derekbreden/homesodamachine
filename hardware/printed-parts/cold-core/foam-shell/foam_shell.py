...
def main():
    ...
    substitute_md(
        ...
        variables={
            ...
            "POCKET_ARC_R": f"{pocket_centerward_arc_outer_radius:g} mm",
            "POCKET_ARC_INNER_R": f"{pocket_centerward_arc_outer_radius - wall_and_floor_thickness:g} mm",
            "POCKET_ARC_TRANSITION_Z": f"{pocket_centerward_arc_transition_z:g} mm",
            "TRANSITION_ARC_R": f"{transition_tank_r:g} mm",
            "COIL_GAP": f"{coil_radial_clearance:g} mm",
            "ELBOW_ENV": f"{above_tank_elbows_height:g} mm",
            "RESERVOIR_GAP": f"{reservoir_clearance:g} mm",
