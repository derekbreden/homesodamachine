...
STEM='display-cover-black-z004-mark2-v9-inset-snaps-12'
...
report=writer.refresh(PROFILE,STAGED,parts=(('display-cover',SOURCE,180.),),offsets=((0.,0.),),
                      title='Machine display cover; original perimeter; snaps inset 1.2 mm each; Mark2',z_trim=.04,plate_border=15.)
...
report.update({'project_sha256':sha(STAGED),'settings_sha256':hashlib.sha256(members[writer.SETTINGS_MEMBER]).hexdigest(),
               ...
               'geometry_change':'Both complete retaining skirts translated 1.2 mm toward center. Original bezel, window and housing receivers unchanged.',
