...
STEM='display-cover-black-z004-mark2-v5-inset-snaps'
...
report=writer.refresh(PROFILE,STAGED,parts=(('display-cover',SOURCE,180.),),offsets=((0.,0.),),
                      title='Machine display cover; original perimeter; snaps inset 0.3 mm each; Mark2',z_trim=.04,plate_border=15.)
...
report.update({'project_sha256':sha(STAGED),'settings_sha256':hashlib.sha256(members[writer.SETTINGS_MEMBER]).hexdigest(),
               ...
               'geometry_change':'Both complete retaining skirts translated 0.3 mm toward center. Original bezel, window and housing receivers unchanged.',
