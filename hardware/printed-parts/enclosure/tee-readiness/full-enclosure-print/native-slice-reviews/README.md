...
Each manifest binds its own geometry receipt, exact native archive and support review. The [current queue](../queue.json) identifies the assigned variants and binds their current assembly qualification. Only assigned variants are eligible for normal printer handoff.

| Job | Printer | Queue role | Evidence |
| --- | --- | --- | --- |
...
| display-cover | Mark2 | printed face down; takes front-top v8 | [2026-09-22-display-cover-mark2-v3](2026-09-22-display-cover-mark2-v3/manifest.json) |
| display-cover | Mark2 | assigned variant: 34 mm skirts for the printed front-top | [2026-09-22-display-cover-mark2-v4](2026-09-22-display-cover-mark2-v4/manifest.json) |
