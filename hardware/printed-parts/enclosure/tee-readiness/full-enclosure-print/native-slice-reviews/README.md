...
| front-bottom | H2C | accepted 09-24, task 1279923918; complete 0.08 mm handhold rounds and flute run-outs; six walls through downward curves only; original order and speeds; rounded faces unsupported | [2026-09-24-enclosure-front-bottom-h2c-v7](2026-09-24-enclosure-front-bottom-h2c-v7/manifest.json) |
