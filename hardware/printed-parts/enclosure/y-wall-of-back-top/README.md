...
|---|---|---|---|---|---|
| 1 | AC inlet | Rear | IEC 60320 C14 panel-mount receptacle ([MXR B07DCXKNXQ](https://www.amazon.com/dp/B07DCXKNXQ)) | rounded rectangular cutout per C14 spec, bored through a printed tunnel standing round it on the inner face | Easternmost station, on the umbilical row's own storey, at the end of the wall the electronics bay stands against — its cordage drops the wall and runs forward to the AC distribution on that column. It lands from **inside**: the rim round its cavity on the pocket floor around the bore, its ears standing [1.84 mm](C14_RIM_PROUD) off that floor with an M3 heat-set either side of the bore. The rim face sits [8.25 mm](C14_RIM_INSET) inside the wall's outer plane and the C13 nose comes down the bore to it and into the cavity. Cord housing is the strain relief — no separate grommet here, and no cable gland anywhere on this wall. Recess detail in §"AC inlet recess" below. |
| 2 | Water inlet | Rear | John Guest PP1208E 1/4" OD black PP push-to-connect bulkhead union ([B00JYFU8MM](https://www.amazon.com/dp/B00JYFU8MM)) — customer pushes the install-kit 1/4" LLDPE into this bulkhead, no tools | ø[17.4 mm](PANEL_HOLE_D) barrel envelope with a tangent teardrop roof (identical SKU and hole to the 3 umbilical PP1208E ports) | **Customer-facing 1/4" JG QC**, at the west end of the umbilical row's own storey, over the west flavor union, its nut riding just above the rear seam-lip band. The install-kit Waterdrop 15UC-UF filter mounts customer-side, inline upstream of this bulkhead (`bom.md §3`). Inboard, the feed runs forward across the band above the cold core and down the foam-face slab: through the PP010822E 1/4" PTC × 1/4" NPT M → GAGIRA 316L SS 3/8" NPT F × 1/4" NPT F reducing coupling → ASSE 1022's 3/8" MPT inlet, then the ASSE 1022's 3/8" MFL outlet → PI4512F6S + PP061208W → 1/4" LLDPE → water-split PP0208E tee → V-K → a clamped 3/8" stub onto the SeaFlo's molded suction barb. The internal ASSE 1022 chain sits *inside* the cabinet (downstream of the ASSE 1022's MFL outlet), not on this wall. Install kit ships **two** under-sink tee options and the white run, filter inline: a JG PP0208E 1/4" PTC × 1/4" PTC × 1/4" PTC union tee (black NSF-cert PP) for homes with 1/4" LLDPE already under the sink, and a John Guest ASVPP1LF 3/8"×3/8"×1/4" angle stop adapter valve for homes with a 3/8" angle stop + braided riser. |
| 4 | CO2 inlet | Rear | neoFit ABU44 acetal black bulkhead connector, 1/4" tube ([FWS](https://www.freshwatersystems.com/products/neofit-acetal-black-bulkhead-connector-1-4-tube)) | Ø[17.3](CO2_HOLE_D) barrel envelope with a tangent teardrop roof, one column east of the carb union on the umbilical row's own storey | **On this wall** — the customer's red 1/4" LLDPE tether from the CGA-320 regulator on their own cylinder pushes into this collet, and the regulator end lands on that regulator's own 7/16"-20 male flare through a gray acetal PM4508F4S female flare connector and PI061008S 5/16"-stem-to-1/4"-socket reducer. Acetal, rated for CO2 and inert gases where the black polypropylene range is not, and black like the four unions beside it. Red bulkhead ring under its flange. Inboard, red tube reaches WR1110 IN, then WR1110 OUT feeds the downstream GASHER check with its arrow toward the carbonator. Gas-rated gray acetal adapters take every threaded end onto tube: PI010822S in the three female ports (WR1110 IN, the check's inlet, the cold-core gas elbow) and PI450822S on the two male outlets (WR1110 OUT, the check's outlet). The check and its measured hose routes lead to the cold core's `co2-in` cap conduit (`bom.md §4`, [`internal-plumbing.md`](/hardware/assembly/internal-plumbing.md) §1). |
| 5 | Backflow-vent observation | — | Moisture sensor in the ASSE drip pan under the Multiplex 19-0897's atmospheric vent | n/a for the vent — no hole in this wall; the pan withdraws through the −X side wall, not this one | The vent does not exit through this wall. It terminates inside the cabinet over the ASSE drip pan; the ESP32-monitored moisture sensor in the pan is the telltale. Detail: [`/hardware/README.md`](/hardware/README.md) §"Safety". The pan itself draws WEST out of its sleeve, through a slot in the −X side wall (`enclosure_assembly.west_wall_ports`) — this wall carries no part of it. |
| 6 | Umbilical port | Rear | 3× John Guest PP1208E 1/4" OD black PP push-to-connect bulkhead unions ([B00JYFU8MM](https://www.amazon.com/dp/B00JYFU8MM)) | 3× ø[17.4 mm](PANEL_HOLE_D) barrel envelopes with tangent teardrop roofs (identical to the water-inlet station's; cut by [`../enclosure/enclosure.py`](/hardware/printed-parts/enclosure/enclosure/enclosure.py) from the pack's `back_ports`, which each union's own panel footprint strikes) | Mid-wall, in the band above the cold core the foam and the rear seam lip leave open. Accepts the 3-tube umbilical bundle that runs from the faucet under the counter down through the countertop to the rear of the appliance: 1× carbonated water + 2× flavor. User pushes each tube into its matching bulkhead — no tools. Same JG black-PP / NSF 51 + NSF 61 / 150 psi @ 70 °F bulkhead family already used inside the cold core, so the SKU is shared and the bulk 10-pack already in stock covers both uses. `bom.md §8`. |
| 7 | Umbilical signal | Rear | [RiteAV RJ11 6P4C black punchdown keystone jack](https://www.riteav.com/products/riteav-rj11-phone-black-punchdown-type-keystone-jack-10-pack) — customer pushes the umbilical's plug in until it clicks, no tools | A **receptacle**, not a hole: aperture [14.8](KEYSTONE_W) × [16.3](KEYSTONE_H) mm at the show face, a [3 mm](KEYSTONE_LIP) lip behind it, a [14.95 × 24.45 mm](KEYSTONE_POCKET) pocket behind that, and an ease at [50°](KEYSTONE_EASE) over the aperture's top edge. The aperture and body pocket have 0.15 mm per-face assembly clearance; their supported floors extend a further [0.25 mm](SUPPORTED_CLEARANCE) toward print-up (machine −Z), retaining the seated jack datum. Struck by `enclosure._keystone_receptacle` from `riteav_keystone` | **SIG-6**, the faucet display's TTL UART and its 5 V. On the shared SODA / FLAVOR-A column, with the receptacle's taller inboard pocket centred between the two tube axes. At the show face its aperture leaves [5.43 mm](KEYSTONE_FLAVOR_FACE_CLEAR) to the flavour chip pocket and [7.88 mm](KEYSTONE_SODA_FACE_CLEAR) to the soda chip pocket; behind the lip, the full pocket leaves [9.19 mm](KEYSTONE_FLAVOR_POCKET_CLEAR) and [5.50 mm](KEYSTONE_SODA_POCKET_CLEAR) to their through-bores. The receptacle's outer boss joins the two port-field bosses into one printed web. **The jack is held by the receptacle's own two catches**, which its tang hooks and its latch snaps over — it goes in from inside the box, tang first, and the body swings down through the ease. Its face lands flush with the wall's outer plane. The wall runs [6 mm](KEYSTONE_WALL_T) here, so the lip comes out of the wall's own section and a boss stands [3.70 mm](KEYSTONE_BOSS) further inboard to carry the pocket's back and the catches — `keystone-receptacle`. Behind it the body reaches [30 mm](KEYSTONE_DEPTH) in total, where the J3 loom punches onto its 110 IDC at [`wiring.md`](/hardware/assembly/wiring.md). Black through, including the dust cover it ships with. 6P4C takes SIG-6's four conductors and an RJ45 plug does not enter it. `bom.md §11`. |
...
The recess is the cutout itself, carried inboard. A printed tunnel stands round the hole on the wall's inner face (`enclosure._c14_tunnel`) and the receptacle sits in that tunnel's pocket with the [31.03 × 22.13 mm](C14_RIM) rim round its cavity bearing on the pocket floor around the bore, its ears [1.84 mm](C14_RIM_PROUD) off the floor and screwed to it, so the bore the C13 nose enters runs the whole depth of wall and tunnel together and the rim face sits [8.25 mm](C14_RIM_INSET) inside the wall's outer plane. The C13 cord mates through that bore. IEC 60320 specifies the male-blade insertion region only, not face-to-face mating distance.

The mounting datum is [x 66.9, z 336.21, seat y 463.05](C14_SEAT), with screw axes at [x 46.9 and 86.9](C14_SCREWS). The nominal working opening is [24.3 × 18.3 mm R1.5](C14_OPENING), with a further [0.25 mm](SUPPORTED_CLEARANCE) toward machine −Z at its supported floor. The tunnel is one [56.07 × 30.55 mm](C14_BLOCK) block from the pocket's mouth to the wall. Cut into its fore face, the pocket is a [49.77 × 22.17 mm](C14_POCKET) rounded/tapered outline — the inlet's [49.77 × 21.9 mm](C14_FLANGE) flange's width and its rim's height — with [0.15 mm](C14_POCKET_SLIP) insertion slip, [5 mm](C14_POCKET_DEPTH) deep from mouth to floor, so the seated part's flange back lies at the mouth; the block keeps at least [3 mm](C14_POCKET_WALL) of material around that outline in XZ. The block runs [10.25 mm](C14_RUN) from the mouth to the wall and its crown fuses into back-top's ceiling slab, so on that ceiling-down print it stands on the bed through the slab and the wall; its underside looks print-up. The block does not move the cutout, screws, or seating plane, and the exterior wall stays on its established planes.

## References

- [`/hardware/README.md`](/hardware/README.md) — broader enclosure context, backflow-vent monitoring, layout.
...
The two flavor unions stand side by side at the [west](FLAVOR_B_END) end on one storey of their own, `enclosure_assembly.FLAVOR_STOREY_DROP` under the lane their runs cruise in (`enclosure_assembly.PANEL_ON_GATE_LANE`), below the carb union's, under the tap-water bulkhead that takes its place on the row's own storey. The rectangular signal jack stands between SODA and FLAVOR-A on their shared column. The CO2 PTC stands one column east of the carb union on the upper storey, and east of it again is the C14 cutout, at the end of the wall the electronics bay stands against. Every station's Z is the pack's, and the wall takes its ceiling from the field's own top edge ([`enclosure.py`](/hardware/printed-parts/enclosure/enclosure/enclosure.py) `port_top`).
...
Design-in-progress. The through-holes, the chips' pockets, the AC inlet's tunnel and flange pocket, and the nameplate's pocket and bosses are all cut into the back-top enclosure piece by `enclosure.py`. This README is the source-of-truth for this wall's connection inventory; `../nameplate/README.md` carries the plate standing beside them.
