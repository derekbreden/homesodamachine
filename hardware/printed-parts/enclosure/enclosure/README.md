...
it touches the model. Front-top has one tree under the pump-bay lintel, one beneath each
grip opening, internal rim ceiling and outer well crown, and one joining the spring bores,
upper web bearings, inner well crowns and pump-jack receptacle roof.
