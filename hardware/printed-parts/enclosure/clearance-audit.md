...
| Tee carriers and side grips | Guide webs, grip roots, retaining rims, backing, center lap, tie slots and supported fastener crowns carry their allocated relief. The actual upper retaining overlap is at least 3 mm after the opening and rim allowances. |
...
| Rear ports and accessories | C14 flange/shroud and keystone body pockets use 0.15 mm static clearance. Nameplate and bulkhead-ring pockets use the shared static allowance; supported pocket edges receive directional relief. The ASSE pan uses 0.25 mm running clearance in its sleeve. |
