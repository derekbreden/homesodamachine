...
| Rear ports and accessories | C14 flange/shroud and keystone body pockets use 0.15 mm static clearance. Nameplate and bulkhead-ring pockets use the shared static allowance; supported pocket edges receive directional relief. The ASSE pan has 0.25 mm running clearance on each Y side and above in its west-wall slot; the supported slot floor has 0.25 mm below it. |
| Hardware supports | Wago pocket roofs and tabs, supported tube/body-seat crowns, anchor tie cavities, ASSE seats and the PRV chase receive their applicable bridge allowance. The surrounding towers and ribs retain their working sections. |
