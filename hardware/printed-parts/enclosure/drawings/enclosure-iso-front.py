...
exported via cq.exporters with HLR (hidden-line removal). projectionDir
(1, -1, 1) gives the front-iso view (camera at +x, -y, +z — front face,
right side, and top visible).

Companion drawing: enclosure-iso-back.py. The geometry is the same; only
the projection direction differs.
