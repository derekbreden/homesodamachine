...
| --- | --- |
| Tee-carrier visible rounds | The upper curve has a clean finish. The lower curve retreats inward between infill contacts, leaving subsequent perimeters in air until the intact interior recovers outward. The fan-off trial is rejected and the steady-cooling trial was stopped after renewed failure. v14 tests six walls only in the lower 6.1 mm and infill first, with original speeds and 15% overlap; physical outcome is pending. Unsupported 0.08 mm visible rounds remain Derek's direction, including enclosure back-top. [Physical record](tee-carrier/physical-acceptance.json). |
