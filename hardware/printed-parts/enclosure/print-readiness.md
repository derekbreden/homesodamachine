...
| --- | --- |
| Tee-carrier visible rounds | The completed Mark2 v11 upper curve is clean; the lower curve curls around layers 20–30 and recovers while still at 0.08 mm. v12 with part cooling off is rejected: deposited edges retreat inward, leaving subsequent perimeters in air until the intact interior recovers outward. v13 tests steady 55% part cooling after layer 3, with physical outcome pending. Unsupported 0.08 mm visible rounds remain Derek's direction, including enclosure back-top; their thermal performance is under evaluation. [Physical record](tee-carrier/physical-acceptance.json). |
