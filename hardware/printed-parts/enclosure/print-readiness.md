...
| --- | --- |
| Tee-carrier visible rounds | Derek provisionally considers the v14 lower curve good enough: no observed spaghetti failure, with a slight concavity. That print combines six walls in the lower 6.1 mm and infill first. His preferred next recipe uses six walls only through print-bottom 0.08 mm rounded bands and the original wall-first order, speeds and 15% overlap. The v15 carrier archive is prepared, not sent; six walls alone is untested. Unsupported visible rounds remain Derek's direction, including enclosure back-top. [Physical record](tee-carrier/physical-acceptance.json). |
