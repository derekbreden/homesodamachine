...
| 5 | Backflow-vent observation | — | Moisture sensor in the internal drip pan under the Multiplex 19-0897's atmospheric vent | n/a for the vent — no panel hole; the basin withdraws through the −X side wall, not this one | The vent does not exit through the panel. It terminates inside the cabinet over a printed drip pan; the ESP32-monitored moisture sensor in the pan is the telltale. Detail: `../../../future.md` §"Backflow vent monitoring". The basin itself draws WEST on rails, out through a slot in the −X side wall (`enclosure-assembly/_contents.west_wall_ports`) — this panel carries no part of it. |
