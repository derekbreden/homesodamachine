...
Each cover skirt sits [0.6 mm](SKIRT_INSET) inboard of its receiver datum; the housing's
slots stay fixed. Each lip overlaps its catch by [0.9 mm](CATCH_OVERLAP) when centered.
...
The [fit trial](../tee-readiness/full-enclosure-print/native-slice-reviews/2026-09-25-display-cover-mark2-v7/README.md)
