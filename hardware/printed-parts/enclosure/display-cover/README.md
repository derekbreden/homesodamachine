...
Each cover skirt sits [0.3 mm](SKIRT_INSET) inboard of its receiver datum; the housing's
slots stay fixed. Each lip overlaps its catch by [1.2 mm](CATCH_OVERLAP) when centered.
