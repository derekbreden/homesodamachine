...
- **Zone B (back-top):** The Zone-B valve trays on the foam-cap top, and behind the cold core the rear service plenum — a full-width, full-height bay carrying the whole electronics shelf (power assembly, controller PCBA, DC distribution block) standing against the rear wall, plus every panel termination: the faucet umbilical, the tap-water inlet, and the C14 mains inlet all penetrate the rear face in the band above the cold core. The CO2 line traverses through here on its way from the front face to the foam-cap's +Z top entry. Tray detail: [`/hardware/printed-parts/electronics/`](/hardware/printed-parts/electronics/). Back panel: [`back-panel/README.md`](/hardware/printed-parts/enclosure/back-panel/README.md).
- **Zone C (front-top):** The flavor funnel over the two peristaltic pumps — one open rectangular basin filling the top wall right of the display, flush with the top surface, lifting out by hand to reach the pumps beneath it. Detail: [`/hardware/printed-parts/zone-c/README.md`](/hardware/printed-parts/zone-c/README.md).
...
- Appliance depth carries the foam shell, the compressor/condenser block in front of it, and the rear service plenum behind it, stacked along Y (currently ~[375 mm](APPLIANCE_DEPTH)).
