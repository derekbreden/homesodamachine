...
COMPONENTS = [
    ...
    _c("tee-y-c", "real", True, "none", "JG PP0208E union tee (fluid topology Y-C) hanging in the junction column: run vertical — V-C-O's drop into the run-up collet, the bag V-E-O return onto the run-down — branch east to pump B (segment 11)"),
    _c("tee-y-f", "real", True, "none", "JG PP0208E union tee (Y-F), the channel-B twin one port row aft: V-D-O above, V-H-O return below, branch east to pump A (segment 21)"),
...
PORTS = [
    ...
    # line nominal.
    _p("P-A-I", "pump-a", "fluid", (98.56, 93.01, 278.17),  "x-", 6.35, "tee-y-f Y-F-3 — segment 21 (channel B suction, to route)", "PP0308E elbow collet, aft station, facing west"),
    ...
    _p("P-B-I", "pump-b", "fluid", (231.44, 79.01, 278.17), "x-", 6.35, "tee-y-c Y-C-3 — segment 11 (channel A suction, to route)", "PP0308E elbow collet, aft station, facing west"),
    ...
    _p("Y-C-3", "tee-y-c", "fluid", *contents.tee_port("tee-y-c", 3), 6.35, "pump-b P-B-I — segment 11 (to route)", "PP0208E branch collet, facing east at the pump row"),
    ...
    _p("Y-F-3", "tee-y-f", "fluid", *contents.tee_port("tee-y-f", 3), 6.35, "pump-a P-A-I — segment 21 (to route)", "PP0208E branch collet, facing east at the pump row"),
