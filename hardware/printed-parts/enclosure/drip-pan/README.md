...
| outer | [51](PAN_LEN) × [76](PAN_DEPTH) × [10](PAN_HEIGHT) mm at the walls |
| over the rim | [71](PAN_RIM_LEN) × [96](PAN_RIM_DEPTH) mm at the flange |
| section | [2.5](PAN_WALL) mm walls on a [3](PAN_FLOOR) mm floor |
| capacity | [22.9](PAN_CAPACITY) mL to the rim |
