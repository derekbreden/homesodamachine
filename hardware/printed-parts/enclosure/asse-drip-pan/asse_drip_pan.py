...
THE PROBE LIES LOOSE. Its continuous lead falls into the open pan with it. On service the pan
draws west until the plate is reachable, the plate is lifted clear, and the empty pan finishes
its travel. Nothing pierces a wet wall and nothing electrical is built into this part.
...
def build():
    ...
    adds no obstruction to the moisture plate.
    """
