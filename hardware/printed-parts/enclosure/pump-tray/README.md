...
| | |
|---|---|
| plate | [82.262](TRAY_W) across × [72.305](TRAY_L) mm |
...
| material, both trays | [95.61](TRAY_VOL) cm³ of `enclosure-front-top` |

## What it covers

**Two storeys of the pump, not one.** That is the whole reason it is a case and not a plate — no plate reaches both.

- The **base plate** lands on the head's own +Z face and wraps its top edge all the way round, [4171](ON_HEAD) mm² of section on that face.
