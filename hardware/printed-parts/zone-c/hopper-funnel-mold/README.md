...
- **Cavity** ([178.5 × 174.0 × 72.5 mm](CAVITY_DIMS)). A block with the funnel exterior
...
- **Core** ([190.5 × 186.0 × 82.5 mm](CORE_DIMS)). The funnel interior (the bore) as a plug,
...
1. **Silicone.** Food-grade platinum-cure, **Shore A 40** (the BBDINO 40A kit in
   ...
   **high tear-strength / elongation**; the 2 mm spout wall is the weak link on
   demold. One funnel is about [80 mL](SIL_VOLUME) of silicone. BBDINO rates it
