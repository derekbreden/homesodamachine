...
- **Cavity** ([175.5 × 136.6 × 160.7 mm](CAVITY_DIMS)). A block with the funnel exterior
...
- **Core** ([187.5 × 148.6 × 170.7 mm](CORE_DIMS)). The funnel interior (the bore) as a plug,
...
1. **Silicone.** Food-grade platinum-cure, **Shore A 40** (the BBDINO 40A kit in
   ...
   **high tear-strength / elongation**; the 2 mm spout wall is the weak link on
   demold. One funnel is about [284 mL](SIL_VOLUME) of silicone. BBDINO rates it
