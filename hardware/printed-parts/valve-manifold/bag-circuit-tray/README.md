...
notch** cut in its hug wall (with a matching floor relief). Each valve drops into
four corner sockets and a port saddle along X. A second tray's floor lands on the column wall tops at a **[63](STACK_PITCH) mm
