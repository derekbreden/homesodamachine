"""Assembled source-select tray: the tray with its 4 valves + 2 Y-dividers
seated in place.
"""
...
import source_select_tray as t
...
def main():
    export_assembly(build(), str(_here.parent / "source-select-assembly.step"))
    print("-> source-select-assembly.step")
