...
- Each valve is rotated about Z so its **port axis points straight at the
  ...
  valves sit at **(±[81.71](SRC_VALVE_X), ±[21.45](SRC_VALVE_Y))**, tilted ~17° off X (the minimum Y
...
A frame plate (Z [-3](TRAY_BOT_Z) → [6](TRAY_TOP_Z)), **[207](SRC_PLATE_W) × [91](SRC_PLATE_D) × [63](STACK_PITCH) mm**, with a **solid floor**. Each
