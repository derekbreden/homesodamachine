...
This is one manifold cell, and `cut_cell` is the cut that makes it: the
[two-valve tray](/hardware/printed-parts/valve-manifold/two-valve-tray/README.md)
— the manifold's own part, five off — is this same cell cut twice into one
plate.
...
- **How the cells combine** is settled for the manifold — two per tray, side
  by side at the valve's own keep-out — but how those five trays stack, and
  how the plumbing runs between them, waits on the manifold being placed.
