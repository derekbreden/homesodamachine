...
The slice generates two support bodies for the base, one for the tip and
three for the plate. The face-down cover has no generated supports.
...
|---|---|---|
| Base / tree-1 | Bed | Counter-end face and broad lower body, retaining the plate seats and donor-body opening. Its labelled interface 1 supports the first turn of the lower signal lane, at CAD X6.60–10.60 / Y16.28–18.53 / Z13.93–15.70 mm. Cleanup access is through the open bottom cable/flavor passage before fitting the donor or plate; removal from this small branch needs a physical reading. |
| Base / tree-2 | Model | Lower neck arch above the lever opening. It preserves the open lever sweep and structural stock joining the round neck; removal is through the front lever opening. |
