...
- Plate center at world ([3.175 mm](PLATE_X), 0). Body sits at world
  (0, 0).
...
2. **Flavor-tube pill slot** — at world ([18.93 mm](PLATE_FLAVOR_X), 0),
   oriented along Y. Two 1/4" tubes [6.35 mm](TUBE_CENTER_Y) apart
   center-to-center, combined into a single rounded-rectangle:
