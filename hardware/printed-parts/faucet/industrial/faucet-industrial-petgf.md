...
estimates **4 h 38 min 59 s and 130.30 g**. Actual extrusion bounds, including
supports and brims, leave at least **24.90 mm of shared-bed border** and
**26.81 mm between parts**.

## Support reading

The base has one bed-rooted support body and eleven explicitly labelled
...
|---|---|---|
| Base / tree-1 | Bed; first labelled interface at print Z2.60 mm after 2.40 mm build-up; body ends at Z62.60 mm | Eight labelled islands lie under the tilted counter-end face. Two reach the donor-arch cheeks, and one reaches the rear lever/tube transition. The mounting face, donor clearance and lever opening retain their working geometry. Remove through the bottom and donor/lever openings before installing hardware; inspect the small interior passages and rear contact. The exposed long neck has no support. |
