...
printed owner's manual in the appliance carton —
...
(order qty 1).** File `touch-flo-under-counter-plate.dxf` (generated by
`touch_flo_under_counter_plate.py` in
[`/hardware/cut-parts/faucet/touch-flo-under-counter-plate/`](/hardware/cut-parts/faucet/touch-flo-under-counter-plate/))
is a single-piece Ø [54.45 mm](PLATE_D) disc with hole positions that
match the TPU mounting gasket exactly — Ø [12.6 mm](SHANK_HOLE_D) shank
pocket at the gasket's shank center and a [13.4 mm](PILL_L) × [7.05 mm](PILL_W)
...
channel widths: [12.6 mm](SHANK_HOLE_D) for the shank, [7.05 mm](PILL_W)
