...
| `refrig-outlet` | aft, +Y | (39, 154, 38.75) | the cold core's evaporator-inlet column and plane |
...
reach them. Each stands on the COLUMN AND PLANE of the mouth it answers to — the
inlet on the compressor's discharge stub, the outlet on the cold core's
