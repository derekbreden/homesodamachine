...
| Station | Face | Location |
|---|---|---|
| `refrig-inlet` | crown, +Z | (27, 146, 151) |
| `refrig-outlet` | intake, −X | (0, 161, 32.5) |
| `fan-power` | exhaust, +X | (56, 30, 75.5) |

Hot gas enters the crown and the liquid line leaves low on the intake face —
a standing serpentine fills from the top and drains from the bottom. The fan
