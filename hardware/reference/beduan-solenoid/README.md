...
|---|---|---|
| 5 cyl + box | ⌀[32.25](BODY_DIA) boss (Z [6](BOSS_Z0)→[30.6](BODY_TOP_Z)) + 4× ⌀[6.8](POST_DIA) corners (Z 0→[30.6](BODY_TOP_Z)) + [32.25](BODY_DIA)×[32.25](BODY_DIA)×[5](TOP_BOX_H) top box (Z [25.6](TOP_BOX_Z0)→[30.6](BODY_TOP_Z)) | white valve body (fluid section) |
...
- The white body is a central round boss (⌀[32.25](BODY_DIA), Z [6](BOSS_Z0) → [30.6](BODY_TOP_Z)) inscribed in
  ...
  is just the four posts. A [5](TOP_BOX_H) mm square box ([32.25](BODY_DIA) × [32.25](BODY_DIA), Z [25.6](TOP_BOX_Z0) → [30.6](BODY_TOP_Z))
...
Overall envelope: [32.25](BODY_DIA) (X) × [59](PORT_LEN) (Y) × [56.6](COIL_TOP) (Z) mm.
