...
top all come out on one plane at Z 67, and below the head's port end hangs a
30 mm boss — the lowest casting on the body, with the head block's own underside
standing clear above it.

That crown stands 5 mm under the drawing's labeled 72, the same gap the length
carries (see [Sources](#sources)).
...
with the position at the barb **tip**: suction at (-36.6, -40.0, 48.0) out -Y,
discharge at (-36.6, +40.0, 48.0) out +Y.
