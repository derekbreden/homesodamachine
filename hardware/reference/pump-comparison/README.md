...
Derek identifies the installed flow as enclosure −X: discharge on −X and inlet on +X.
The mounting feet are removable and slide fore and aft along the casing channels.
