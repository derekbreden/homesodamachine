...
A non-combustible sheet-metal shroud encloses the compressor's terminal block area as the implementation of UL 60335-2-89 conformance for the R-600a charge (per [`regulatory.md`](regulatory.md)). 0.059" G90 hot-dipped galvanized steel, laser-cut + bent at SendCutSend. Open-bottom 5-sided shroud (or two-piece U-channel + back wall, TBD on the box-bend max-flange-height constraint), dropping over the compressor from above.
