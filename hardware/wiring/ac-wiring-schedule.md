...
| SIG-4 | SENSORS J4 `IO25` + `V5` + `GND` | DIGITEN flow meter (inline on the carbonated-water riser, lying in the pocket ahead of the cold core's crown, boss up) | pulse + [5 V](V_LOGIC) + GND | [22](AWG_LV) | [~150 mm](LEN_MID) (internal, within the electronics-shelf zone) | Pulse interrupt; flow detection is internal — does not leave the enclosure. |
