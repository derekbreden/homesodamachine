...
| AC-6 | Earth bus on chassis ground point | Compressor body, under a floor screw | G | [18](AWG_COMP_LEAD) | [~400 mm](LEN_COMPRESSOR) | Ring terminal both ends | The SJOOW's third conductor, in the same jacket as AC-4 / AC-5. Bonds the compressor body to chassis ground — the machine's only bond to the refrigeration metalwork. The ring goes under the screw head on the grommet's steel bushing, never into the rubber. |
