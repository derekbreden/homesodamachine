...
| AC-4 | Teyleten relay #1 contact output ("normally open") | Compressor terminal block (inside shroud) | H_switched | [18](AWG_SHROUD) | [~400 mm](LEN_COMPRESSOR) | Crimp fork to relay; female disconnect to compressor terminal | Switched hot. One of the three conductors of the [18 AWG](AWG_SHROUD_U) SJOOW jacketed lead that crosses the shroud wall through its cable gland — gauge and gland clamping range per [`/hardware/cut-parts/compressor-shroud/README.md`](/hardware/cut-parts/compressor-shroud/README.md) "Penetrations". Length includes service slack. |
| AC-5 | AC distribution block (N) | Compressor terminal block (inside shroud) | N | [18](AWG_SHROUD) | [~400 mm](LEN_COMPRESSOR) | Crimp ferrule at distribution block; female disconnect to compressor terminal | The SJOOW's second conductor, through the same gland as AC-4. |
| AC-6 | Earth bus on chassis ground point | Compressor body / shroud ground lug | G | [18](AWG_SHROUD) | [~400 mm](LEN_COMPRESSOR) | Ring terminal both ends | The SJOOW's third conductor, through the same gland as AC-4 / AC-5. Bonds the metal shroud and the compressor body to chassis ground. |
