...
The appliance has two functional electrical zones, both on the AC inlet side. The cold core occupies the rear of the enclosure (insulated, no electronics). The compressor + condenser sit middle-bottom. Everything else lives on **one electronics shelf lying on the cold core's foam-cap top, on the rear-panel C14 inlet's column**.

| Zone | Location | Contents |
|---|---|---|
| Electronics shelf | On the foam-cap top in the band above the cold core, ahead of the rear-panel port bodies | C14 inlet, AC distribution block, Mean Well IRM-90-12ST PSU, Teyleten relay #1 (compressor switch), Teyleten relay #2 (diaphragm pump switch), [12 V](V_DC) distribution block, controller PCBA, ground bus |
