...
| DC-5 | L298N OUT-A / OUT-B | Kamoer pump A / pump B | + + GND each | [22](AWG_SIG) | [~250 mm](LEN_PUMP) to the cartridge + [~100 mm](LEN_SHORT_2) of pump-lead pigtail | Quick-disconnect spades on the pump leads (BOM §11) | Pump cartridge is field-replaceable; the spade terminals are the tool-free disconnect. |
