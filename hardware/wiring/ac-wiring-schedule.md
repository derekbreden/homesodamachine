...
The appliance has two functional electrical zones, both on the AC inlet side. The cold core occupies the rear of the enclosure (insulated, no electronics). The compressor + condenser sit middle-bottom. Everything else lives on **one electronics shelf standing in the rear service plenum, directly under the rear-panel C14 inlet**.

| Zone | Location | Contents |
|---|---|---|
| Electronics shelf | Rear service plenum, standing against the rear wall under the C14 inlet | C14 inlet, AC distribution block, Mean Well IRM-90-12ST PSU, Teyleten relay #1 (compressor switch), Teyleten relay #2 (diaphragm pump switch), [12 V](V_DC) distribution block, controller PCBA, ground bus |
