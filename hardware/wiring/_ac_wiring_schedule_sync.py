...
len_mid_mm = 150        # LV-1/2/3, DC-4, DC-6/DC-7 valve fan-outs, SIG-4
...
len_compressor_mm = 400 # AC-1 (rear C14 → power tray via the +X channel), AC-4, AC-5, AC-6 (power tray → compressor through grommet), DC-8 (power tray → side-wall fan)
